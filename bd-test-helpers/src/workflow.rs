...
pub mod log_match {
  ...
  pub fn message_equals(msg: &str) -> LogMatcher {
    super::make_log_message_matcher(msg, Operator::OPERATOR_EQUALS)
  }
  ...
  pub fn message_regex_matches(pattern: &str) -> LogMatcher {
    super::make_log_message_matcher(pattern, Operator::OPERATOR_REGEX)
  }
  ...
  pub fn field_equals(key: &str, value: &str) -> LogMatcher {
    super::make_log_tag_matcher(key, value)
  }
  ...
  pub fn field_not_equals(key: &str, value: &str) -> LogMatcher {
    super::log_field_matcher(key, value, Operator::OPERATOR_NOT_EQUALS)
  }
  ...
  pub fn field_regex_matches(key: &str, pattern: &str) -> LogMatcher {
    super::log_field_matcher(key, pattern, Operator::OPERATOR_REGEX)
  }
  ...
  pub fn field_double_equals(key: &str, value: f64) -> LogMatcher {
    super::log_field_double_matcher(key, value, Operator::OPERATOR_EQUALS)
  }
  ...
  pub fn field_double(key: &str, value: f64, operator: Operator) -> LogMatcher {
    super::log_field_double_matcher(key, value, operator)
  }
  ...
  pub fn ios() -> LogMatcher {
    super::log_field_matcher("os", "iOS", Operator::OPERATOR_EQUALS)
  }
  ...
  pub fn android() -> LogMatcher {
    super::log_field_matcher("os", "Android", Operator::OPERATOR_EQUALS)
  }
}
