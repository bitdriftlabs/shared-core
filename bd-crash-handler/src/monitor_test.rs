...
async fn test_log_report_fields() {
  ...
  let name = Some(builder.create_string("BigProb"));
  let reason = Some(builder.create_string("missing meta"));
  ...
  let app_id = Some(builder.create_string("com.example.foo.widget"));
  let version = Some(builder.create_string("4.15"));
  let cf_bundle_version = Some(builder.create_string("5"));
  ...
  let os_version = Some(builder.create_string("3.1"));
