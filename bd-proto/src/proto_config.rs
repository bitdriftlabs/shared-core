  ...
  vec![
    ProtoConfig {
      ...
      inputs: &[
        ...
        "../api/src/bitdrift/public/unary/timeline/v1/spans.proto",
      ],
      includes: PROTO_INCLUDES,
      use_tokio_bytes: false,
      file_header: true,
    ...
    ProtoConfig {
      ...
      inputs: &[
        ...
        "../api/src/bitdrift/public/unary/admin/v1/teams.proto",
    ...
    ProtoConfig {
      output_dir: "src/protos/public_api/usage",
      inputs: &["../api/src/bitdrift/public/unary/usage/v1/api.proto"],
      includes: PROTO_INCLUDES,
      use_tokio_bytes: false,
      file_header: true,
    },
