...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    otations\xf8\x01\x01\xa2\x02\x04GAPIJ\xb2s\n\x07\x12\x05\x0e\0\xfa\x02\
    ...
    \xf1\x02\x01\x1a\xacS\x20#\x20gRPC\x20Transcoding\n\n\x20gRPC\x20Transco\
    ding\x20is\x20a\x20feature\x20for\x20mapping\x20between\x20a\x20gRPC\x20\
    method\x20and\x20one\x20or\n\x20more\x20HTTP\x20REST\x20endpoints.\x20It\
    \x20allows\x20developers\x20to\x20build\x20a\x20single\x20API\x20service\
    \n\x20that\x20supports\x20both\x20gRPC\x20APIs\x20and\x20REST\x20APIs.\
    \x20Many\x20systems,\x20including\x20[Google\n\x20APIs](https://github.c\
    om/googleapis/googleapis),\n\x20[Cloud\x20Endpoints](https://cloud.googl\
    e.com/endpoints),\x20[gRPC\n\x20Gateway](https://github.com/grpc-ecosyst\
    em/grpc-gateway),\n\x20and\x20[Envoy](https://github.com/envoyproxy/envo\
    y)\x20proxy\x20support\x20this\x20feature\n\x20and\x20use\x20it\x20for\
    \x20large\x20scale\x20production\x20services.\n\n\x20`HttpRule`\x20defin\
    es\x20the\x20schema\x20of\x20the\x20gRPC/REST\x20mapping.\x20The\x20mapp\
    ing\x20specifies\n\x20how\x20different\x20portions\x20of\x20the\x20gRPC\
    \x20request\x20message\x20are\x20mapped\x20to\x20the\x20URL\n\x20path,\
    \x20URL\x20query\x20parameters,\x20and\x20HTTP\x20request\x20body.\x20It\
    \x20also\x20controls\x20how\x20the\n\x20gRPC\x20response\x20message\x20i\
    s\x20mapped\x20to\x20the\x20HTTP\x20response\x20body.\x20`HttpRule`\x20i\
    s\n\x20typically\x20specified\x20as\x20an\x20`google.api.http`\x20annota\
    tion\x20on\x20the\x20gRPC\x20method.\n\n\x20Each\x20mapping\x20specifies\
    \x20a\x20URL\x20path\x20template\x20and\x20an\x20HTTP\x20method.\x20The\
    \x20path\n\x20template\x20may\x20refer\x20to\x20one\x20or\x20more\x20fie\
    lds\x20in\x20the\x20gRPC\x20request\x20message,\x20as\x20long\n\x20as\
    \x20each\x20field\x20is\x20a\x20non-repeated\x20field\x20with\x20a\x20pr\
    imitive\x20(non-message)\x20type.\n\x20The\x20path\x20template\x20contro\
    ls\x20how\x20fields\x20of\x20the\x20request\x20message\x20are\x20mapped\
    \x20to\n\x20the\x20URL\x20path.\n\n\x20Example:\n\n\x20\x20\x20\x20\x20s\
    ervice\x20Messaging\x20{\n\x20\x20\x20\x20\x20\x20\x20rpc\x20GetMessage(\
    GetMessageRequest)\x20returns\x20(Message)\x20{\n\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20option\x20(google.api.http)\x20=\x20{\n\x20\x20\x20\x20\
    ...
    pped\x20to\x20URL\x20path.\n\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20m\
    essage\x20Message\x20{\n\x20\x20\x20\x20\x20\x20\x20string\x20text\x20=\
    \x201;\x20//\x20The\x20resource\x20content.\n\x20\x20\x20\x20\x20}\n\n\
    \x20This\x20enables\x20an\x20HTTP\x20REST\x20to\x20gRPC\x20mapping\x20as\
    \x20below:\n\n\x20HTTP\x20|\x20gRPC\n\x20-----|-----\n\x20`GET\x20/v1/me\
    ssages/123456`\x20\x20|\x20`GetMessage(name:\x20\"messages/123456\")`\n\
    \n\x20Any\x20fields\x20in\x20the\x20request\x20message\x20which\x20are\
    \x20not\x20bound\x20by\x20the\x20path\x20template\n\x20automatically\x20\
    become\x20HTTP\x20query\x20parameters\x20if\x20there\x20is\x20no\x20HTTP\
    ...
    \x20\x20\x20\x20\x20\x20\x20get:\"/v1/messages/{message_id}\"\n\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20};\n\x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\
    ...
    \x20//\x20Mapped\x20to\x20URL\x20path.\n\x20\x20\x20\x20\x20\x20\x20int6\
    4\x20revision\x20=\x202;\x20\x20\x20\x20//\x20Mapped\x20to\x20URL\x20que\
    ry\x20parameter\x20`revision`.\n\x20\x20\x20\x20\x20\x20\x20SubMessage\
    \x20sub\x20=\x203;\x20\x20\x20\x20//\x20Mapped\x20to\x20URL\x20query\x20\
    parameter\x20`sub.subfield`.\n\x20\x20\x20\x20\x20}\n\n\x20This\x20enabl\
    es\x20a\x20HTTP\x20JSON\x20to\x20RPC\x20mapping\x20as\x20below:\n\n\x20H\
    TTP\x20|\x20gRPC\n\x20-----|-----\n\x20`GET\x20/v1/messages/123456?revis\
    ion=2&sub.subfield=foo`\x20|\n\x20`GetMessage(message_id:\x20\"123456\"\
    \x20revision:\x202\x20sub:\x20SubMessage(subfield:\n\x20\"foo\"))`\n\n\
    \x20Note\x20that\x20fields\x20which\x20are\x20mapped\x20to\x20URL\x20que\
    ry\x20parameters\x20must\x20have\x20a\n\x20primitive\x20type\x20or\x20a\
    \x20repeated\x20primitive\x20type\x20or\x20a\x20non-repeated\x20message\
    \x20type.\n\x20In\x20the\x20case\x20of\x20a\x20repeated\x20type,\x20the\
    \x20parameter\x20can\x20be\x20repeated\x20in\x20the\x20URL\n\x20as\x20`.\
    ..?param=A&param=B`.\x20In\x20the\x20case\x20of\x20a\x20message\x20type,\
    \x20each\x20field\x20of\x20the\n\x20message\x20is\x20mapped\x20to\x20a\
    \x20separate\x20parameter,\x20such\x20as\n\x20`...?foo.a=A&foo.b=B&foo.c\
    =C`.\n\n\x20For\x20HTTP\x20methods\x20that\x20allow\x20a\x20request\x20b\
    ody,\x20the\x20`body`\x20field\n\x20specifies\x20the\x20mapping.\x20Cons\
    ider\x20a\x20REST\x20update\x20method\x20on\x20the\n\x20message\x20resou\
    rce\x20collection:\n\n\x20\x20\x20\x20\x20service\x20Messaging\x20{\n\
    \x20\x20\x20\x20\x20\x20\x20rpc\x20UpdateMessage(UpdateMessageRequest)\
    \x20returns\x20(Message)\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20optio\
    n\x20(google.api.http)\x20=\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20patch:\x20\"/v1/messages/{message_id}\"\n\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20body:\x20\"message\"\n\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20};\n\x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20}\n\
    \x20\x20\x20\x20\x20message\x20UpdateMessageRequest\x20{\n\x20\x20\x20\
    \x20\x20\x20\x20string\x20message_id\x20=\x201;\x20//\x20mapped\x20to\
    \x20the\x20URL\n\x20\x20\x20\x20\x20\x20\x20Message\x20message\x20=\x202\
    ;\x20\x20\x20//\x20mapped\x20to\x20the\x20body\n\x20\x20\x20\x20\x20}\n\
    \n\x20The\x20following\x20HTTP\x20JSON\x20to\x20RPC\x20mapping\x20is\x20\
    enabled,\x20where\x20the\n\x20representation\x20of\x20the\x20JSON\x20in\
    \x20the\x20request\x20body\x20is\x20determined\x20by\n\x20protos\x20JSON\
    \x20encoding:\n\n\x20HTTP\x20|\x20gRPC\n\x20-----|-----\n\x20`PATCH\x20/\
    v1/messages/123456\x20{\x20\"text\":\x20\"Hi!\"\x20}`\x20|\x20`UpdateMes\
    sage(message_id:\n\x20\"123456\"\x20message\x20{\x20text:\x20\"Hi!\"\x20\
    })`\n\n\x20The\x20special\x20name\x20`*`\x20can\x20be\x20used\x20in\x20t\
    he\x20body\x20mapping\x20to\x20define\x20that\n\x20every\x20field\x20not\
    \x20bound\x20by\x20the\x20path\x20template\x20should\x20be\x20mapped\x20\
    to\x20the\n\x20request\x20body.\x20\x20This\x20enables\x20the\x20followi\
    ng\x20alternative\x20definition\x20of\n\x20the\x20update\x20method:\n\n\
    \x20\x20\x20\x20\x20service\x20Messaging\x20{\n\x20\x20\x20\x20\x20\x20\
    \x20rpc\x20UpdateMessage(Message)\x20returns\x20(Message)\x20{\n\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20option\x20(google.api.http)\x20=\x20{\n\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20patch:\x20\"/v1/messages/{messag\
    e_id}\"\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20body:\x20\"*\"\n\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20};\n\x20\x20\x20\x20\x20\x20\x20}\n\
    \x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20message\x20Message\x20{\n\x20\
    \x20\x20\x20\x20\x20\x20string\x20message_id\x20=\x201;\n\x20\x20\x20\
    \x20\x20\x20\x20string\x20text\x20=\x202;\n\x20\x20\x20\x20\x20}\n\n\n\
    \x20The\x20following\x20HTTP\x20JSON\x20to\x20RPC\x20mapping\x20is\x20en\
    abled:\n\n\x20HTTP\x20|\x20gRPC\n\x20-----|-----\n\x20`PATCH\x20/v1/mess\
    ages/123456\x20{\x20\"text\":\x20\"Hi!\"\x20}`\x20|\x20`UpdateMessage(me\
    ssage_id:\n\x20\"123456\"\x20text:\x20\"Hi!\")`\n\n\x20Note\x20that\x20w\
    hen\x20using\x20`*`\x20in\x20the\x20body\x20mapping,\x20it\x20is\x20not\
    \x20possible\x20to\n\x20have\x20HTTP\x20parameters,\x20as\x20all\x20fiel\
    ds\x20not\x20bound\x20by\x20the\x20path\x20end\x20in\n\x20the\x20body.\
    \x20This\x20makes\x20this\x20option\x20more\x20rarely\x20used\x20in\x20p\
    ractice\x20when\n\x20defining\x20REST\x20APIs.\x20The\x20common\x20usage\
    \x20of\x20`*`\x20is\x20in\x20custom\x20methods\n\x20which\x20don't\x20us\
    e\x20the\x20URL\x20at\x20all\x20for\x20transferring\x20data.\n\n\x20It\
    \x20is\x20possible\x20to\x20define\x20multiple\x20HTTP\x20methods\x20for\
    \x20one\x20RPC\x20by\x20using\n\x20the\x20`additional_bindings`\x20optio\
    n.\x20Example:\n\n\x20\x20\x20\x20\x20service\x20Messaging\x20{\n\x20\
    \x20\x20\x20\x20\x20\x20rpc\x20GetMessage(GetMessageRequest)\x20returns\
    \x20(Message)\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20option\x20(googl\
    e.api.http)\x20=\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20get:\
    \x20\"/v1/messages/{message_id}\"\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20additional_bindings\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20get:\x20\"/v1/users/{user_id}/messages/{message_id}\"\n\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20};\n\x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20}\n\
    \x20\x20\x20\x20\x20message\x20GetMessageRequest\x20{\n\x20\x20\x20\x20\
    \x20\x20\x20string\x20message_id\x20=\x201;\n\x20\x20\x20\x20\x20\x20\
    \x20string\x20user_id\x20=\x202;\n\x20\x20\x20\x20\x20}\n\n\x20This\x20e\
    nables\x20the\x20following\x20two\x20alternative\x20HTTP\x20JSON\x20to\
    \x20RPC\x20mappings:\n\n\x20HTTP\x20|\x20gRPC\n\x20-----|-----\n\x20`GET\
    \x20/v1/messages/123456`\x20|\x20`GetMessage(message_id:\x20\"123456\")`\
    \n\x20`GET\x20/v1/users/me/messages/123456`\x20|\x20`GetMessage(user_id:\
    \x20\"me\"\x20message_id:\n\x20\"123456\")`\n\n\x20##\x20Rules\x20for\
    \x20HTTP\x20mapping\n\n\x201.\x20Leaf\x20request\x20fields\x20(recursive\
    \x20expansion\x20nested\x20messages\x20in\x20the\x20request\n\x20\x20\
    \x20\x20message)\x20are\x20classified\x20into\x20three\x20categories:\n\
    \x20\x20\x20\x20-\x20Fields\x20referred\x20by\x20the\x20path\x20template\
    .\x20They\x20are\x20passed\x20via\x20the\x20URL\x20path.\n\x20\x20\x20\
    \x20-\x20Fields\x20referred\x20by\x20the\x20[HttpRule.body][google.api.H\
    ttpRule.body].\x20They\n\x20\x20\x20\x20are\x20passed\x20via\x20the\x20H\
    TTP\n\x20\x20\x20\x20\x20\x20request\x20body.\n\x20\x20\x20\x20-\x20All\
    \x20other\x20fields\x20are\x20passed\x20via\x20the\x20URL\x20query\x20pa\
    rameters,\x20and\x20the\n\x20\x20\x20\x20\x20\x20parameter\x20name\x20is\
    \x20the\x20field\x20path\x20in\x20the\x20request\x20message.\x20A\x20rep\
    eated\n\x20\x20\x20\x20\x20\x20field\x20can\x20be\x20represented\x20as\
    \x20multiple\x20query\x20parameters\x20under\x20the\x20same\n\x20\x20\
    \x20\x20\x20\x20name.\n\x20\x202.\x20If\x20[HttpRule.body][google.api.Ht\
    tpRule.body]\x20is\x20\"*\",\x20there\x20is\x20no\x20URL\n\x20\x20query\
    \x20parameter,\x20all\x20fields\n\x20\x20\x20\x20\x20are\x20passed\x20vi\
    a\x20URL\x20path\x20and\x20HTTP\x20request\x20body.\n\x20\x203.\x20If\
    \x20[HttpRule.body][google.api.HttpRule.body]\x20is\x20omitted,\x20there\
    \x20is\x20no\x20HTTP\n\x20\x20request\x20body,\x20all\n\x20\x20\x20\x20\
    \x20fields\x20are\x20passed\x20via\x20URL\x20path\x20and\x20URL\x20query\
    \x20parameters.\n\n\x20###\x20Path\x20template\x20syntax\n\n\x20\x20\x20\
    \x20\x20Template\x20=\x20\"/\"\x20Segments\x20[\x20Verb\x20]\x20;\n\x20\
    \x20\x20\x20\x20Segments\x20=\x20Segment\x20{\x20\"/\"\x20Segment\x20}\
    \x20;\n\x20\x20\x20\x20\x20Segment\x20\x20=\x20\"*\"\x20|\x20\"**\"\x20|\
    \x20LITERAL\x20|\x20Variable\x20;\n\x20\x20\x20\x20\x20Variable\x20=\x20\
    \"{\"\x20FieldPath\x20[\x20\"=\"\x20Segments\x20]\x20\"}\"\x20;\n\x20\
    \x20\x20\x20\x20FieldPath\x20=\x20IDENT\x20{\x20\".\"\x20IDENT\x20}\x20;\
    ...
    \x20segment.\x20The\x20syntax\x20`**`\x20matches\n\x20zero\x20or\x20more\
    \x20URL\x20path\x20segments,\x20which\x20must\x20be\x20the\x20last\x20pa\
    rt\x20of\x20the\x20URL\x20path\n\x20except\x20the\x20`Verb`.\n\n\x20The\
    \x20syntax\x20`Variable`\x20matches\x20part\x20of\x20the\x20URL\x20path\
    \x20as\x20specified\x20by\x20its\n\x20template.\x20A\x20variable\x20temp\
    late\x20must\x20not\x20contain\x20other\x20variables.\x20If\x20a\x20vari\
    able\n\x20matches\x20a\x20single\x20path\x20segment,\x20its\x20template\
    \x20may\x20be\x20omitted,\x20e.g.\x20`{var}`\n\x20is\x20equivalent\x20to\
    \x20`{var=*}`.\n\n\x20The\x20syntax\x20`LITERAL`\x20matches\x20literal\
    \x20text\x20in\x20the\x20URL\x20path.\x20If\x20the\x20`LITERAL`\n\x20con\
    tains\x20any\x20reserved\x20character,\x20such\x20characters\x20should\
    \x20be\x20percent-encoded\n\x20before\x20the\x20matching.\n\n\x20If\x20a\
    \x20variable\x20contains\x20exactly\x20one\x20path\x20segment,\x20such\
    \x20as\x20`\"{var}\"`\x20or\n\x20`\"{var=*}\"`,\x20when\x20such\x20a\x20\
    variable\x20is\x20expanded\x20into\x20a\x20URL\x20path\x20on\x20the\x20c\
    lient\n\x20side,\x20all\x20characters\x20except\x20`[-_.~0-9a-zA-Z]`\x20\
    are\x20percent-encoded.\x20The\n\x20server\x20side\x20does\x20the\x20rev\
    erse\x20decoding.\x20Such\x20variables\x20show\x20up\x20in\x20the\n\x20[\
    Discovery\n\x20Document](https://developers.google.com/discovery/v1/refe\
    rence/apis)\x20as\n\x20`{var}`.\n\n\x20If\x20a\x20variable\x20contains\
    \x20multiple\x20path\x20segments,\x20such\x20as\x20`\"{var=foo/*}\"`\n\
    \x20or\x20`\"{var=**}\"`,\x20when\x20such\x20a\x20variable\x20is\x20expa\
    nded\x20into\x20a\x20URL\x20path\x20on\x20the\n\x20client\x20side,\x20al\
    l\x20characters\x20except\x20`[-_.~/0-9a-zA-Z]`\x20are\x20percent-encode\
    d.\n\x20The\x20server\x20side\x20does\x20the\x20reverse\x20decoding,\x20\
    except\x20\"%2F\"\x20and\x20\"%2f\"\x20are\x20left\n\x20unchanged.\x20Su\
    ch\x20variables\x20show\x20up\x20in\x20the\n\x20[Discovery\n\x20Document\
    ](https://developers.google.com/discovery/v1/reference/apis)\x20as\n\x20\
    `{+var}`.\n\n\x20##\x20Using\x20gRPC\x20API\x20Service\x20Configuration\
    \n\n\x20gRPC\x20API\x20Service\x20Configuration\x20(service\x20config)\
    \x20is\x20a\x20configuration\x20language\n\x20for\x20configuring\x20a\
    ...
    \x02\0\x12\x04\xc0\x02\x02\x16\x1a\x80\x01\x20Selects\x20a\x20method\x20\
    to\x20which\x20this\x20rule\x20applies.\n\n\x20Refer\x20to\x20[selector]\
    [google.api.DocumentationRule.selector]\x20for\x20syntax\n\x20details.\n\
    \n\r\n\x05\x04\x01\x02\0\x05\x12\x04\xc0\x02\x02\x08\n\r\n\x05\x04\x01\
    \x02\0\x01\x12\x04\xc0\x02\t\x11\n\r\n\x05\x04\x01\x02\0\x03\x12\x04\xc0\
    \x02\x14\x15\n\xd0\x01\n\x04\x04\x01\x08\0\x12\x06\xc5\x02\x02\xdb\x02\
    \x03\x1a\xbf\x01\x20Determines\x20the\x20URL\x20pattern\x20is\x20matched\
    \x20by\x20this\x20rules.\x20This\x20pattern\x20can\x20be\n\x20used\x20wi\
    th\x20any\x20of\x20the\x20{get|put|post|delete|patch}\x20methods.\x20A\
    \x20custom\x20method\n\x20can\x20be\x20defined\x20using\x20the\x20'custo\
    m'\x20field.\n\n\r\n\x05\x04\x01\x08\0\x01\x12\x04\xc5\x02\x08\x0f\n\\\n\
    \x04\x04\x01\x02\x01\x12\x04\xc8\x02\x04\x13\x1aN\x20Maps\x20to\x20HTTP\
    ...
    \x01\x02\x01\x03\x12\x04\xc8\x02\x11\x12\n@\n\x04\x04\x01\x02\x02\x12\
    \x04\xcb\x02\x04\x13\x1a2\x20Maps\x20to\x20HTTP\x20PUT.\x20Used\x20for\
    ...
    \x02\x04\x03\x12\x04\xd1\x02\x14\x15\nA\n\x04\x04\x01\x02\x05\x12\x04\
    \xd4\x02\x04\x15\x1a3\x20Maps\x20to\x20HTTP\x20PATCH.\x20Used\x20for\x20\
    ...
    \x02\x06\x12\x04\xda\x02\x04!\x1a\x89\x02\x20The\x20custom\x20pattern\
    ...
    \x04\x01\x02\x06\x03\x12\x04\xda\x02\x1f\x20\n\xc4\x02\n\x04\x04\x01\x02\
    \x07\x12\x04\xe3\x02\x02\x12\x1a\xb5\x02\x20The\x20name\x20of\x20the\x20\
    ...
    \x04\x01\x02\x07\x03\x12\x04\xe3\x02\x10\x11\n\x99\x02\n\x04\x04\x01\x02\
    \x08\x12\x04\xeb\x02\x02\x1c\x1a\x8a\x02\x20Optional.\x20The\x20name\x20\
    ...
    \x01\x02\x08\x03\x12\x04\xeb\x02\x19\x1b\n\xbb\x01\n\x04\x04\x01\x02\t\
    \x12\x04\xf0\x02\x02-\x1a\xac\x01\x20Additional\x20HTTP\x20bindings\x20f\
    ...
    \x01\x05\x12\x04\xf9\x02\x02\x08\n\r\n\x05\x04\x02\x02\x01\x01\x12\x04\
