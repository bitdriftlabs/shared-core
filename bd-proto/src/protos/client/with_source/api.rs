...
pub struct ClientKillFile {
    ...
    ///  This is the hash of the target domain. If the target domain changes, we will ignore the
    ///  kill_until timestamp.
    // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.ClientKillFile.target_domain_hash)
    pub target_domain_hash: ::std::vec::Vec<u8>,
    // special fields
...
impl ClientKillFile {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "target_domain_hash",
            |m: &ClientKillFile| { &m.target_domain_hash },
            |m: &mut ClientKillFile| { &mut m.target_domain_hash },
        ));
...
impl ::protobuf::Message for ClientKillFile {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                26 => {
                    self.target_domain_hash = is.read_bytes()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.target_domain_hash.is_empty() {
            my_size += ::protobuf::rt::bytes_size(3, &self.target_domain_hash);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.target_domain_hash.is_empty() {
            os.write_bytes(3, &self.target_domain_hash)?;
        }
    ...
    fn default_instance() -> &'static ClientKillFile {
        static instance: ClientKillFile = ClientKillFile {
            ...
            target_domain_hash: ::std::vec::Vec::new(),
...
///  Used by the server to tell the client to clear or set state.
// @@protoc_insertion_point(message:bitdrift_public.protobuf.client.v1.ClientStateUpdate)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct ClientStateUpdate {
    // message oneof groups
    pub update_type: ::std::option::Option<client_state_update::Update_type>,
    // special fields
    // @@protoc_insertion_point(special_field:bitdrift_public.protobuf.client.v1.ClientStateUpdate.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a ClientStateUpdate {
    fn default() -> &'a ClientStateUpdate {
        <ClientStateUpdate as ::protobuf::Message>::default_instance()
    }
}

impl ClientStateUpdate {
    pub fn new() -> ClientStateUpdate {
        ::std::default::Default::default()
    }

    // .bitdrift_public.protobuf.client.v1.ClientStateUpdate.ClearClientState clear_client_state = 1;

    pub fn clear_client_state(&self) -> &client_state_update::ClearClientState {
        match self.update_type {
            ::std::option::Option::Some(client_state_update::Update_type::ClearClientState(ref v)) => v,
            _ => <client_state_update::ClearClientState as ::protobuf::Message>::default_instance(),
        }
    }

    pub fn clear_clear_client_state(&mut self) {
        self.update_type = ::std::option::Option::None;
    }

    pub fn has_clear_client_state(&self) -> bool {
        match self.update_type {
            ::std::option::Option::Some(client_state_update::Update_type::ClearClientState(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_clear_client_state(&mut self, v: client_state_update::ClearClientState) {
        self.update_type = ::std::option::Option::Some(client_state_update::Update_type::ClearClientState(v))
    }

    // Mutable pointer to the field.
    pub fn mut_clear_client_state(&mut self) -> &mut client_state_update::ClearClientState {
        if let ::std::option::Option::Some(client_state_update::Update_type::ClearClientState(_)) = self.update_type {
        } else {
            self.update_type = ::std::option::Option::Some(client_state_update::Update_type::ClearClientState(client_state_update::ClearClientState::new()));
        }
        match self.update_type {
            ::std::option::Option::Some(client_state_update::Update_type::ClearClientState(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_clear_client_state(&mut self) -> client_state_update::ClearClientState {
        if self.has_clear_client_state() {
            match self.update_type.take() {
                ::std::option::Option::Some(client_state_update::Update_type::ClearClientState(v)) => v,
                _ => panic!(),
            }
        } else {
            client_state_update::ClearClientState::new()
        }
    }

    // .bitdrift_public.protobuf.client.v1.ClientStateUpdate.SetClientState set_client_state = 2;

    pub fn set_client_state(&self) -> &client_state_update::SetClientState {
        match self.update_type {
            ::std::option::Option::Some(client_state_update::Update_type::SetClientState(ref v)) => v,
            _ => <client_state_update::SetClientState as ::protobuf::Message>::default_instance(),
        }
    }

    pub fn clear_set_client_state(&mut self) {
        self.update_type = ::std::option::Option::None;
    }

    pub fn has_set_client_state(&self) -> bool {
        match self.update_type {
            ::std::option::Option::Some(client_state_update::Update_type::SetClientState(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_set_client_state(&mut self, v: client_state_update::SetClientState) {
        self.update_type = ::std::option::Option::Some(client_state_update::Update_type::SetClientState(v))
    }

    // Mutable pointer to the field.
    pub fn mut_set_client_state(&mut self) -> &mut client_state_update::SetClientState {
        if let ::std::option::Option::Some(client_state_update::Update_type::SetClientState(_)) = self.update_type {
        } else {
            self.update_type = ::std::option::Option::Some(client_state_update::Update_type::SetClientState(client_state_update::SetClientState::new()));
        }
        match self.update_type {
            ::std::option::Option::Some(client_state_update::Update_type::SetClientState(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_set_client_state(&mut self) -> client_state_update::SetClientState {
        if self.has_set_client_state() {
            match self.update_type.take() {
                ::std::option::Option::Some(client_state_update::Update_type::SetClientState(v)) => v,
                _ => panic!(),
            }
        } else {
            client_state_update::SetClientState::new()
        }
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_oneof_message_has_get_mut_set_accessor::<_, client_state_update::ClearClientState>(
            "clear_client_state",
            ClientStateUpdate::has_clear_client_state,
            ClientStateUpdate::clear_client_state,
            ClientStateUpdate::mut_clear_client_state,
            ClientStateUpdate::set_clear_client_state,
        ));
        fields.push(::protobuf::reflect::rt::v2::make_oneof_message_has_get_mut_set_accessor::<_, client_state_update::SetClientState>(
            "set_client_state",
            ClientStateUpdate::has_set_client_state,
            ClientStateUpdate::set_client_state,
            ClientStateUpdate::mut_set_client_state,
            ClientStateUpdate::set_set_client_state,
        ));
        oneofs.push(client_state_update::Update_type::generated_oneof_descriptor_data());
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<ClientStateUpdate>(
            "ClientStateUpdate",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for ClientStateUpdate {
    const NAME: &'static str = "ClientStateUpdate";
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    self.update_type = ::std::option::Option::Some(client_state_update::Update_type::ClearClientState(is.read_message()?));
                },
                18 => {
                    self.update_type = ::std::option::Option::Some(client_state_update::Update_type::SetClientState(is.read_message()?));
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let ::std::option::Option::Some(ref v) = self.update_type {
            match v {
                &client_state_update::Update_type::ClearClientState(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
                },
                &client_state_update::Update_type::SetClientState(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
                },
            };
    ...
    fn new() -> ClientStateUpdate {
        ClientStateUpdate::new()
    }
    ...
    fn default_instance() -> &'static ClientStateUpdate {
        static instance: ClientStateUpdate = ClientStateUpdate {
...
impl ::protobuf::MessageFull for ClientStateUpdate {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("ClientStateUpdate").unwrap()).clone()
    }
}

impl ::std::fmt::Display for ClientStateUpdate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ClientStateUpdate {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

/// Nested message and enums of message `ClientStateUpdate`
pub mod client_state_update {

    #[derive(Clone,PartialEq,Debug)]
    // @@protoc_insertion_point(oneof:bitdrift_public.protobuf.client.v1.ClientStateUpdate.update_type)
    pub enum Update_type {
        // @@protoc_insertion_point(oneof_field:bitdrift_public.protobuf.client.v1.ClientStateUpdate.clear_client_state)
        ClearClientState(ClearClientState),
        // @@protoc_insertion_point(oneof_field:bitdrift_public.protobuf.client.v1.ClientStateUpdate.set_client_state)
    ...
    impl ::protobuf::OneofFull for Update_type {
        fn descriptor() -> ::protobuf::reflect::OneofDescriptor {
            ...
            descriptor.get(|| <super::ClientStateUpdate as ::protobuf::MessageFull>::descriptor().oneof_by_name("update_type").unwrap()).clone()
        }
    }
    ...
    // @@protoc_insertion_point(message:bitdrift_public.protobuf.client.v1.ClientStateUpdate.ClearClientState)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct ClearClientState {
        // message fields
        // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.ClientStateUpdate.ClearClientState.scope)
        pub scope: ::protobuf::EnumOrUnknown<super::super::scope::StateScope>,
        // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.ClientStateUpdate.ClearClientState.state_key)
        pub state_key: ::std::string::String,
        // special fields
        // @@protoc_insertion_point(special_field:bitdrift_public.protobuf.client.v1.ClientStateUpdate.ClearClientState.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }

    impl<'a> ::std::default::Default for &'a ClearClientState {
        fn default() -> &'a ClearClientState {
            <ClearClientState as ::protobuf::Message>::default_instance()
        }
    }

    impl ClearClientState {
        pub fn new() -> ClearClientState {
            ::std::default::Default::default()
        }
        ...
        pub(in super) fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
            ...
            fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
                "scope",
                |m: &ClearClientState| { &m.scope },
                |m: &mut ClearClientState| { &mut m.scope },
            ));
            fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
                "state_key",
                |m: &ClearClientState| { &m.state_key },
                |m: &mut ClearClientState| { &mut m.state_key },
            ));
            ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<ClearClientState>(
                "ClientStateUpdate.ClearClientState",
                fields,
                oneofs,
            )
        }
    ...
    impl ::protobuf::Message for ClearClientState {
        const NAME: &'static str = "ClearClientState";
        ...
        fn new() -> ClearClientState {
            ClearClientState::new()
        }
        ...
        fn default_instance() -> &'static ClearClientState {
            static instance: ClearClientState = ClearClientState {
    ...
    impl ::protobuf::MessageFull for ClearClientState {
        fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
            static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
            descriptor.get(|| super::file_descriptor().message_by_package_relative_name("ClientStateUpdate.ClearClientState").unwrap()).clone()
        }
    }

    impl ::std::fmt::Display for ClearClientState {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            ::protobuf::text_format::fmt(self, f)
        }
    }

    impl ::protobuf::reflect::ProtobufValue for ClearClientState {
        type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
    }

    // @@protoc_insertion_point(message:bitdrift_public.protobuf.client.v1.ClientStateUpdate.SetClientState)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct SetClientState {
        // message fields
        // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.ClientStateUpdate.SetClientState.scope)
        pub scope: ::protobuf::EnumOrUnknown<super::super::scope::StateScope>,
        // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.ClientStateUpdate.SetClientState.state_key)
        pub state_key: ::std::string::String,
        // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.ClientStateUpdate.SetClientState.state_value)
        pub state_value: ::protobuf::MessageField<super::super::state_payload::StateValue>,
        // special fields
        // @@protoc_insertion_point(special_field:bitdrift_public.protobuf.client.v1.ClientStateUpdate.SetClientState.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }

    impl<'a> ::std::default::Default for &'a SetClientState {
        fn default() -> &'a SetClientState {
            <SetClientState as ::protobuf::Message>::default_instance()
        }
    }

    impl SetClientState {
        pub fn new() -> SetClientState {
            ::std::default::Default::default()
        }
        ...
        pub(in super) fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
            ...
            fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
                "scope",
                |m: &SetClientState| { &m.scope },
                |m: &mut SetClientState| { &mut m.scope },
            ));
            fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
                "state_key",
                |m: &SetClientState| { &m.state_key },
                |m: &mut SetClientState| { &mut m.state_key },
            ));
            fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::super::state_payload::StateValue>(
                "state_value",
                |m: &SetClientState| { &m.state_value },
                |m: &mut SetClientState| { &mut m.state_value },
            ));
            ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<SetClientState>(
                "ClientStateUpdate.SetClientState",
                fields,
                oneofs,
            )
        }
    ...
    impl ::protobuf::Message for SetClientState {
        const NAME: &'static str = "SetClientState";
        ...
        fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
            while let Some(tag) = is.read_raw_tag_or_eof()? {
                match tag {
                    ...
                    26 => {
                        ::protobuf::rt::read_singular_message_into_field(is, &mut self.state_value)?;
                    },
                    tag => {
                        ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                    },
        ...
        fn default_instance() -> &'static SetClientState {
            static instance: SetClientState = SetClientState {
                scope: ::protobuf::EnumOrUnknown::from_i32(0),
                state_key: ::std::string::String::new(),
                state_value: ::protobuf::MessageField::none(),
                special_fields: ::protobuf::SpecialFields::new(),
            };
            &instance
        }
    ...
    impl ::protobuf::MessageFull for SetClientState {
        fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
            static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
            descriptor.get(|| super::file_descriptor().message_by_package_relative_name("ClientStateUpdate.SetClientState").unwrap()).clone()
        }
    }

    impl ::std::fmt::Display for SetClientState {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            ::protobuf::text_format::fmt(self, f)
        }
    }

    impl ::protobuf::reflect::ProtobufValue for SetClientState {
        type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
    }
}
...
pub struct HandshakeRequest {
    ...
    // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.HandshakeRequest.analytics)
    pub analytics: ::protobuf::MessageField<handshake_request::Analytics>,
    ...
    // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.HandshakeRequest.startup_stats_upload)
    pub startup_stats_upload: ::protobuf::MessageField<StatsUploadRequest>,
    // special fields
...
impl HandshakeRequest {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, handshake_request::Analytics>(
            "analytics",
            |m: &HandshakeRequest| { &m.analytics },
            |m: &mut HandshakeRequest| { &mut m.analytics },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, StatsUploadRequest>(
            "startup_stats_upload",
            |m: &HandshakeRequest| { &m.startup_stats_upload },
            |m: &mut HandshakeRequest| { &mut m.startup_stats_upload },
        ));
...
impl ::protobuf::Message for HandshakeRequest {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                90 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.startup_stats_upload)?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.startup_stats_upload.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
    ...
    fn clear(&mut self) {
        ...
        self.startup_stats_upload.clear();
        self.special_fields.clear();
    }
...
/// Nested message and enums of message `HandshakeRequest`
pub mod handshake_request {
    ///  Connection and stats pipeline analytics that are independent of the stats payload itself.
    // @@protoc_insertion_point(message:bitdrift_public.protobuf.client.v1.HandshakeRequest.Analytics)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct Analytics {
        // message fields
        ///  The logical connection number since this client process started. It starts at one, advances
        ///  only after the prior handshake receives a handshake response, and is not persisted across
        ///  process restarts.
        // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.HandshakeRequest.Analytics.connection_count_since_process_start)
        pub connection_count_since_process_start: u64,
        ...
        // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.HandshakeRequest.Analytics.stats_pipeline)
        pub stats_pipeline: ::protobuf::MessageField<analytics::StatsPipelineAnalyticsReport>,
        // special fields
        // @@protoc_insertion_point(special_field:bitdrift_public.protobuf.client.v1.HandshakeRequest.Analytics.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }

    impl<'a> ::std::default::Default for &'a Analytics {
        fn default() -> &'a Analytics {
            <Analytics as ::protobuf::Message>::default_instance()
        }
    }
    ...
    impl Analytics {
        ...
        pub(in super) fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
            ...
            fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
                ...
                |m: &Analytics| { &m.connection_count_since_process_start },
                |m: &mut Analytics| { &mut m.connection_count_since_process_start },
            ));
            fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, analytics::StatsPipelineAnalyticsReport>(
                "stats_pipeline",
                |m: &Analytics| { &m.stats_pipeline },
                |m: &mut Analytics| { &mut m.stats_pipeline },
            ));
            ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<Analytics>(
                "HandshakeRequest.Analytics",
                fields,
                oneofs,
            )
        }
    ...
    impl ::protobuf::Message for Analytics {
        ...
        fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
            while let Some(tag) = is.read_raw_tag_or_eof()? {
                match tag {
                    8 => {
                        self.connection_count_since_process_start = is.read_uint64()?;
                    },
                    18 => {
                        ::protobuf::rt::read_singular_message_into_field(is, &mut self.stats_pipeline)?;
                    },
                    tag => {
                        ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                    },
        ...
        fn compute_size(&self) -> u64 {
            let mut my_size = 0;
            if self.connection_count_since_process_start != 0 {
                my_size += ::protobuf::rt::uint64_size(1, self.connection_count_since_process_start);
            }
            if let Some(v) = self.stats_pipeline.as_ref() {
                let len = v.compute_size();
                my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
            }
            my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        ...
        fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
            if self.connection_count_since_process_start != 0 {
                os.write_uint64(1, self.connection_count_since_process_start)?;
            }
            if let Some(v) = self.stats_pipeline.as_ref() {
                ::protobuf::rt::write_message_field_with_cached_size(2, v, os)?;
            }
        ...
        fn clear(&mut self) {
            self.connection_count_since_process_start = 0;
            self.stats_pipeline.clear();
            self.special_fields.clear();
        }

        fn default_instance() -> &'static Analytics {
            static instance: Analytics = Analytics {
                connection_count_since_process_start: 0,
                stats_pipeline: ::protobuf::MessageField::none(),
                special_fields: ::protobuf::SpecialFields::new(),
            };
            &instance
        }
    ...
    impl ::protobuf::MessageFull for Analytics {
        fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
            static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
            descriptor.get(|| super::file_descriptor().message_by_package_relative_name("HandshakeRequest.Analytics").unwrap()).clone()
        }
    }
    ...
    impl ::protobuf::reflect::ProtobufValue for Analytics {
        type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
    }

    /// Nested message and enums of message `Analytics`
    pub mod analytics {
        ...
        // @@protoc_insertion_point(message:bitdrift_public.protobuf.client.v1.HandshakeRequest.Analytics.StatsPipelineAnalyticsReport)
        #[derive(PartialEq,Clone,Default,Debug)]
        pub struct StatsPipelineAnalyticsReport {
            // message fields
            ///  Stable ID used by the server to deduplicate this ACK-reset report.
            // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.HandshakeRequest.Analytics.StatsPipelineAnalyticsReport.report_id)
            ...
            // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.HandshakeRequest.Analytics.StatsPipelineAnalyticsReport.analytics)
            pub analytics: ::protobuf::MessageField<super::super::super::metric::StatsPipelineAnalytics>,
            // special fields
            // @@protoc_insertion_point(special_field:bitdrift_public.protobuf.client.v1.HandshakeRequest.Analytics.StatsPipelineAnalyticsReport.special_fields)
            pub special_fields: ::protobuf::SpecialFields,
        }

        impl<'a> ::std::default::Default for &'a StatsPipelineAnalyticsReport {
            fn default() -> &'a StatsPipelineAnalyticsReport {
                <StatsPipelineAnalyticsReport as ::protobuf::Message>::default_instance()
            }
        }

        impl StatsPipelineAnalyticsReport {
            pub fn new() -> StatsPipelineAnalyticsReport {
                ::std::default::Default::default()
            }
            ...
            pub(in super::super) fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
                ...
                fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
                    "report_id",
                    |m: &StatsPipelineAnalyticsReport| { &m.report_id },
                    |m: &mut StatsPipelineAnalyticsReport| { &mut m.report_id },
                ));
                fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::super::super::metric::StatsPipelineAnalytics>(
                    "analytics",
                    |m: &StatsPipelineAnalyticsReport| { &m.analytics },
                    |m: &mut StatsPipelineAnalyticsReport| { &mut m.analytics },
                ));
                ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<StatsPipelineAnalyticsReport>(
                    "HandshakeRequest.Analytics.StatsPipelineAnalyticsReport",
                    fields,
                    oneofs,
                )
            }
        ...
        impl ::protobuf::Message for StatsPipelineAnalyticsReport {
            const NAME: &'static str = "StatsPipelineAnalyticsReport";
            ...
            fn new() -> StatsPipelineAnalyticsReport {
                StatsPipelineAnalyticsReport::new()
            }
            ...
            fn default_instance() -> &'static StatsPipelineAnalyticsReport {
                static instance: StatsPipelineAnalyticsReport = StatsPipelineAnalyticsReport {
        ...
        impl ::protobuf::MessageFull for StatsPipelineAnalyticsReport {
            fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
                static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
                descriptor.get(|| super::super::file_descriptor().message_by_package_relative_name("HandshakeRequest.Analytics.StatsPipelineAnalyticsReport").unwrap()).clone()
            }
        }

        impl ::std::fmt::Display for StatsPipelineAnalyticsReport {
            fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                ::protobuf::text_format::fmt(self, f)
            }
        }

        impl ::protobuf::reflect::ProtobufValue for StatsPipelineAnalyticsReport {
            type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
        }
    }
}
...
pub struct LogUploadRequest {
    ...
    // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.LogUploadRequest.trigger_uuids)
    pub trigger_uuids: ::std::vec::Vec<::std::string::String>,
...
impl LogUploadRequest {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "trigger_uuids",
            |m: &LogUploadRequest| { &m.trigger_uuids },
            |m: &mut LogUploadRequest| { &mut m.trigger_uuids },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ackless",
...
impl ::protobuf::Message for LogUploadRequest {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                50 => {
                    self.trigger_uuids.push(is.read_string()?);
                },
                32 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        for value in &self.trigger_uuids {
...
pub struct UploadArtifactRequest {
    ...
    pub command_id: ::std::option::Option<::std::string::String>,
    ///  The encoding of contents. Only workflow and direct command attachments may use zlib encoding.
...
impl UploadArtifactRequest {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::workflow::WorkflowReportHandoff>(
...
pub struct HandshakeResponse {
    ...
    ///  list of updates.
    // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.HandshakeResponse.client_state_updates)
    pub client_state_updates: ::std::vec::Vec<ClientStateUpdate>,
    ...
    // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.HandshakeResponse.analytics_ack)
    pub analytics_ack: ::protobuf::MessageField<handshake_response::AnalyticsAck>,
    // special fields
...
impl HandshakeResponse {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            ...
            |m: &HandshakeResponse| { &m.client_state_updates },
            |m: &mut HandshakeResponse| { &mut m.client_state_updates },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, handshake_response::AnalyticsAck>(
            "analytics_ack",
            |m: &HandshakeResponse| { &m.analytics_ack },
            |m: &mut HandshakeResponse| { &mut m.analytics_ack },
        ));
...
impl ::protobuf::Message for HandshakeResponse {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                34 => {
                    self.client_state_updates.push(is.read_message()?);
                },
                42 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.analytics_ack)?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        for value in &self.client_state_updates {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
        if let Some(v) = self.analytics_ack.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        for v in &self.client_state_updates {
            ::protobuf::rt::write_message_field_with_cached_size(4, v, os)?;
        };
        if let Some(v) = self.analytics_ack.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(5, v, os)?;
    ...
    fn clear(&mut self) {
        ...
        self.client_state_updates.clear();
        self.analytics_ack.clear();
        self.special_fields.clear();
    }
    ...
    fn default_instance() -> &'static HandshakeResponse {
        static instance: HandshakeResponse = HandshakeResponse {
            ...
            client_state_updates: ::std::vec::Vec::new(),
            analytics_ack: ::protobuf::MessageField::none(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
pub mod handshake_response {
    // @@protoc_insertion_point(message:bitdrift_public.protobuf.client.v1.HandshakeResponse.AnalyticsAck)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct AnalyticsAck {
        ...
        // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.HandshakeResponse.AnalyticsAck.report_id)
        pub report_id: ::std::string::String,
        // special fields
        // @@protoc_insertion_point(special_field:bitdrift_public.protobuf.client.v1.HandshakeResponse.AnalyticsAck.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }

    impl<'a> ::std::default::Default for &'a AnalyticsAck {
        fn default() -> &'a AnalyticsAck {
            <AnalyticsAck as ::protobuf::Message>::default_instance()
        }
    }

    impl AnalyticsAck {
        pub fn new() -> AnalyticsAck {
            ::std::default::Default::default()
        }
        ...
        pub(in super) fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
            ...
            fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
                "report_id",
                |m: &AnalyticsAck| { &m.report_id },
                |m: &mut AnalyticsAck| { &mut m.report_id },
            ));
            ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<AnalyticsAck>(
                "HandshakeResponse.AnalyticsAck",
                fields,
                oneofs,
            )
        }
    ...
    impl ::protobuf::Message for AnalyticsAck {
        const NAME: &'static str = "AnalyticsAck";
        ...
        fn default_instance() -> &'static AnalyticsAck {
            static instance: AnalyticsAck = AnalyticsAck {
                report_id: ::std::string::String::new(),
                special_fields: ::protobuf::SpecialFields::new(),
            };
            &instance
    ...
    impl ::protobuf::MessageFull for AnalyticsAck {
        fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
            static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
            descriptor.get(|| super::file_descriptor().message_by_package_relative_name("HandshakeResponse.AnalyticsAck").unwrap()).clone()
        }
    }

    impl ::std::fmt::Display for AnalyticsAck {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            ::protobuf::text_format::fmt(self, f)
        }
    }

    impl ::protobuf::reflect::ProtobufValue for AnalyticsAck {
        type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
    }
...
pub mod stats_upload_request {
    ...
    pub struct Snapshot {
        ...
        ///  Number of prior attempts to upload this snapshot. The original upload is zero, which also
        ///  preserves the behavior of clients that do not yet send this field.
        // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.StatsUploadRequest.Snapshot.retry_count)
        pub retry_count: u32,
        ///  Stable monotonic identifier assigned when this source snapshot is created. Zero indicates
        ///  that the client does not support source sequence identifiers.
...
pub struct ConfigurationUpdate {
    ...
    ///  If set, the client should update or clear the corresponding state according to the provided
    ///  list of updates.
    // @@protoc_insertion_point(field:bitdrift_public.protobuf.client.v1.ConfigurationUpdate.client_state_updates)
    pub client_state_updates: ::std::vec::Vec<ClientStateUpdate>,
    // message oneof groups
...
impl ConfigurationUpdate {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "client_state_updates",
            |m: &ConfigurationUpdate| { &m.client_state_updates },
            |m: &mut ConfigurationUpdate| { &mut m.client_state_updates },
        ));
...
#[derive(Clone,Copy,PartialEq,Eq,Debug,Hash)]
// @@protoc_insertion_point(enum:bitdrift_public.protobuf.client.v1.ArtifactPayloadEncoding)
pub enum ArtifactPayloadEncoding {
    // @@protoc_insertion_point(enum_value:bitdrift_public.protobuf.client.v1.ArtifactPayloadEncoding.ARTIFACT_PAYLOAD_ENCODING_RAW)
    ARTIFACT_PAYLOAD_ENCODING_RAW = 0,
    // @@protoc_insertion_point(enum_value:bitdrift_public.protobuf.client.v1.ArtifactPayloadEncoding.ARTIFACT_PAYLOAD_ENCODING_ZLIB)
    ARTIFACT_PAYLOAD_ENCODING_ZLIB = 1,
}

impl ::protobuf::Enum for ArtifactPayloadEncoding {
    const NAME: &'static str = "ArtifactPayloadEncoding";

    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::option::Option<ArtifactPayloadEncoding> {
        match value {
            0 => ::std::option::Option::Some(ArtifactPayloadEncoding::ARTIFACT_PAYLOAD_ENCODING_RAW),
            1 => ::std::option::Option::Some(ArtifactPayloadEncoding::ARTIFACT_PAYLOAD_ENCODING_ZLIB),
            _ => ::std::option::Option::None
        }
    }

    fn from_str(str: &str) -> ::std::option::Option<ArtifactPayloadEncoding> {
        match str {
            "ARTIFACT_PAYLOAD_ENCODING_RAW" => ::std::option::Option::Some(ArtifactPayloadEncoding::ARTIFACT_PAYLOAD_ENCODING_RAW),
            "ARTIFACT_PAYLOAD_ENCODING_ZLIB" => ::std::option::Option::Some(ArtifactPayloadEncoding::ARTIFACT_PAYLOAD_ENCODING_ZLIB),
            _ => ::std::option::Option::None
        }
    }

    const VALUES: &'static [ArtifactPayloadEncoding] = &[
        ArtifactPayloadEncoding::ARTIFACT_PAYLOAD_ENCODING_RAW,
        ArtifactPayloadEncoding::ARTIFACT_PAYLOAD_ENCODING_ZLIB,
    ];
}

impl ::protobuf::EnumFull for ArtifactPayloadEncoding {
    fn enum_descriptor() -> ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::EnumDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().enum_by_package_relative_name("ArtifactPayloadEncoding").unwrap()).clone()
    }
...
impl ::std::default::Default for ArtifactPayloadEncoding {
    fn default() -> Self {
        ArtifactPayloadEncoding::ARTIFACT_PAYLOAD_ENCODING_RAW
    }
}

impl ArtifactPayloadEncoding {
    fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
        ::protobuf::reflect::GeneratedEnumDescriptorData::new::<ArtifactPayloadEncoding>("ArtifactPayloadEncoding")
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    c/protobuf/logging/v1/payload.proto\x1a-bitdrift_public/protobuf/state/v\
    1/scope.proto\x1a5bitdrift_public/protobuf/state/v1/state_payload.proto\
    \x1a3bitdrift_public/protobuf/workflow/v1/workflow.proto\x1a\x1egoogle/p\
    rotobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17val\
    idate/validate.proto\"\x9b\x01\n\x0eClientKillFile\x12\x20\n\x0capi_key_\
    hash\x18\x01\x20\x01(\x0cR\napiKeyHash\x129\n\nkill_until\x18\x02\x20\
    \x01(\x0b2\x1a.google.protobuf.TimestampR\tkillUntil\x12,\n\x12target_do\
    main_hash\x18\x03\x20\x01(\x0cR\x10targetDomainHash\"\xc7\x04\n\x11Clien\
    tStateUpdate\x12v\n\x12clear_client_state\x18\x01\x20\x01(\x0b2F.bitdrif\
    t_public.protobuf.client.v1.ClientStateUpdate.ClearClientStateH\0R\x10cl\
    earClientState\x12p\n\x10set_client_state\x18\x02\x20\x01(\x0b2D.bitdrif\
    t_public.protobuf.client.v1.ClientStateUpdate.SetClientStateH\0R\x0esetC\
    lientState\x1at\n\x10ClearClientState\x12C\n\x05scope\x18\x01\x20\x01(\
    \x0e2-.bitdrift_public.protobuf.state.v1.StateScopeR\x05scope\x12\x1b\n\
    \tstate_key\x18\x02\x20\x01(\tR\x08stateKey\x1a\xc2\x01\n\x0eSetClientSt\
    ate\x12C\n\x05scope\x18\x01\x20\x01(\x0e2-.bitdrift_public.protobuf.stat\
    e.v1.StateScopeR\x05scope\x12\x1b\n\tstate_key\x18\x02\x20\x01(\tR\x08st\
    ateKey\x12N\n\x0bstate_value\x18\x03\x20\x01(\x0b2-.bitdrift_public.prot\
    obuf.state.v1.StateValueR\nstateValueB\r\n\x0bupdate_type\"\xc9\x03\n\
    \x12StateUpdateRequest\x12{\n\x14opaque_entity_update\x18\x01\x20\x01(\
    \x0b2I.bitdrift_public.protobuf.client.v1.StateUpdateRequest.OpaqueEntit\
    yUpdateR\x12opaqueEntityUpdate\x12p\n\x10started_sessions\x18\x02\x20\
    \x03(\x0b2E.bitdrift_public.protobuf.client.v1.StateUpdateRequest.Starte\
    dSessionR\x0fstartedSessions\x1aj\n\x0eStartedSession\x12\x1d\n\nsession\
    _id\x18\x01\x20\x01(\tR\tsessionId\x129\n\nstart_time\x18\x02\x20\x01(\
    \x0b2\x1a.google.protobuf.TimestampR\tstartTime\x1aX\n\x12OpaqueEntityUp\
    date\x12-\n\x10opaque_entity_id\x18\x01\x20\x01(\tH\0R\x0eopaqueEntityId\
    \x88\x01\x01B\x13\n\x11_opaque_entity_id\"\xd5\t\n\x10HandshakeRequest\
    ...
    e\x18\x04\x20\x01(\tR\x13runtimeVersionNonce\x12<\n\x1aprevious_disconne\
    ct_reason\x18\x06\x20\x01(\tR\x18previousDisconnectReason\x12\x1d\n\nsle\
    ep_mode\x18\x07\x20\x01(\x08R\tsleepMode\x123\n\x13opaque_client_state\
    \x18\x08\x20\x01(\x0cH\0R\x11opaqueClientState\x88\x01\x01\x12Y\n\x0csta\
    te_update\x18\t\x20\x01(\x0b26.bitdrift_public.protobuf.client.v1.StateU\
    pdateRequestR\x0bstateUpdate\x12\\\n\tanalytics\x18\n\x20\x01(\x0b2>.bit\
    drift_public.protobuf.client.v1.HandshakeRequest.AnalyticsR\tanalytics\
    \x12h\n\x14startup_stats_upload\x18\x0b\x20\x01(\x0b26.bitdrift_public.p\
    rotobuf.client.v1.StatsUploadRequestR\x12startupStatsUpload\x1a\xf8\x02\
    \n\tAnalytics\x12N\n$connection_count_since_process_start\x18\x01\x20\
    \x01(\x04R\x20connectionCountSinceProcessStart\x12\x82\x01\n\x0estats_pi\
    peline\x18\x02\x20\x01(\x0b2[.bitdrift_public.protobuf.client.v1.Handsha\
    keRequest.Analytics.StatsPipelineAnalyticsReportR\rstatsPipeline\x1a\x95\
    \x01\n\x1cStatsPipelineAnalyticsReport\x12\x1b\n\treport_id\x18\x01\x20\
    \x01(\tR\x08reportId\x12X\n\tanalytics\x18\x02\x20\x01(\x0b2:.bitdrift_p\
    ublic.protobuf.client.v1.StatsPipelineAnalyticsR\tanalytics\x1ar\n\x19St\
    aticDeviceMetadataEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12?\
    \n\x05value\x18\x02\x20\x01(\x0b2).bitdrift_public.protobuf.logging.v1.D\
    ataR\x05value:\x028\x01B\x16\n\x14_opaque_client_stateJ\x04\x08\x02\x10\
    \x03J\x04\x08\x05\x10\x06\"\xd5\x04\n\x16LogUploadIntentRequest\x12\x1b\
    \n\tlog_count\x18\x01\x20\x01(\rR\x08logCount\x12\x1d\n\nbyte_count\x18\
    \x02\x20\x01(\rR\tbyteCount\x12\x1b\n\tbuffer_id\x18\x03\x20\x01(\tR\x08\
    bufferId\x12\x1f\n\x0bintent_uuid\x18\x04\x20\x01(\tR\nintentUuid\x12\
    \x1d\n\nsession_id\x18\x06\x20\x01(\tR\tsessionId\x12\x87\x01\n\x16workf\
    low_action_upload\x18\x05\x20\x01(\x0b2O.bitdrift_public.protobuf.client\
    .v1.LogUploadIntentRequest.WorkflowActionUploadH\0R\x14workflowActionUpl\
    oad\x12\x8d\x01\n\x18explicit_session_capture\x18\x07\x20\x01(\x0b2Q.bit\
    drift_public.protobuf.client.v1.LogUploadIntentRequest.ExplicitSessionCa\
    ptureH\0R\x16explicitSessionCapture\x1aF\n\x14WorkflowActionUpload\x12.\
    \n\x13workflow_action_ids\x18\x01\x20\x03(\tR\x11workflowActionIds\x1a1\
    \n\x16ExplicitSessionCapture\x12\x17\n\x02id\x18\x01\x20\x01(\tR\x02idB\
    \x07\xfaB\x04r\x02\x10\x01B\r\n\x0bintent_type\"\xbb\x02\n\x17LogUploadI\
    ntentResponse\x12\x1f\n\x0bintent_uuid\x18\x01\x20\x01(\tR\nintentUuid\
    \x12~\n\x12upload_immediately\x18\x02\x20\x01(\x0b2M.bitdrift_public.pro\
    ...
    ft_public.protobuf.client.v1.ApiResponse(\x010\x01J\xc2\xaf\x02\n\x07\
    \x12\x05\x07\0\xf9\x06\x01\n\xb8\x02\n\x01\x0c\x12\x03\x07\0\x122\xad\
    ...
    \x0e\0:\n\t\n\x02\x03\x04\x12\x03\x0f\09\n\t\n\x02\x03\x05\x12\x03\x10\0\
    9\n\t\n\x02\x03\x06\x12\x03\x11\0;\n\t\n\x02\x03\x07\x12\x03\x12\07\n\t\
    \n\x02\x03\x08\x12\x03\x13\0?\n\t\n\x02\x03\t\x12\x03\x14\0=\n\t\n\x02\
    \x03\n\x12\x03\x15\0(\n\t\n\x02\x03\x0b\x12\x03\x16\0)\n\t\n\x02\x03\x0c\
    \x12\x03\x17\0!\n\x94\x01\n\x02\x04\0\x12\x04\x1b\0(\x01\x1a\x87\x01\x20\
    File\x20written\x20to\x20disk\x20if\x20the\x20client\x20has\x20been\x20p\
    laced\x20in\x20the\x20\"killed\"\x20state\x20and\x20told\x20not\x20to\n\
    \x20contact\x20the\x20server\x20for\x20some\x20period\x20of\x20time.\n\n\
    \n\n\x03\x04\0\x01\x12\x03\x1b\x08\x16\n\xe4\x01\n\x04\x04\0\x02\0\x12\
    \x03\x1f\x02\x19\x1a\xd6\x01\x20This\x20is\x20the\x20hash\x20of\x20the\
    \x20API\x20key.\x20If\x20the\x20API\x20key\x20hash\x20changes,\x20we\x20\
    will\x20always\x20ignore\x20the\n\x20kill_until\x20timestamp.\x20This\
    \x20is\x20to\x20ease\x20local\x20development/onboarding\x20when\x20folks\
    \x20might\x20be\n\x20confused\x20about\x20what\x20API\x20key\x20to\x20us\
    e.\n\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03\x1f\x02\x07\n\x0c\n\x05\x04\0\
    \x02\0\x01\x12\x03\x1f\x08\x14\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03\x1f\
    \x17\x18\nr\n\x04\x04\0\x02\x01\x12\x03#\x02+\x1ae\x20The\x20time\x20the\
    \x20client\x20will\x20be\x20killed\x20until.\x20After\x20this\x20time\
    \x20it\x20will\x20try\x20to\x20contact\x20the\x20server\n\x20again.\n\n\
    \x0c\n\x05\x04\0\x02\x01\x06\x12\x03#\x02\x1b\n\x0c\n\x05\x04\0\x02\x01\
    \x01\x12\x03#\x1c&\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03#)*\n}\n\x04\x04\
    \0\x02\x02\x12\x03'\x02\x1f\x1ap\x20This\x20is\x20the\x20hash\x20of\x20t\
    he\x20target\x20domain.\x20If\x20the\x20target\x20domain\x20changes,\x20\
    we\x20will\x20ignore\x20the\n\x20kill_until\x20timestamp.\n\n\x0c\n\x05\
    \x04\0\x02\x02\x05\x12\x03'\x02\x07\n\x0c\n\x05\x04\0\x02\x02\x01\x12\
    \x03'\x08\x1a\n\x0c\n\x05\x04\0\x02\x02\x03\x12\x03'\x1d\x1e\nJ\n\x02\
    \x04\x01\x12\x04+\0;\x01\x1a>\x20Used\x20by\x20the\x20server\x20to\x20te\
    ll\x20the\x20client\x20to\x20clear\x20or\x20set\x20state.\n\n\n\n\x03\
    \x04\x01\x01\x12\x03+\x08\x19\n\x0c\n\x04\x04\x01\x03\0\x12\x04,\x02/\
    \x03\n\x0c\n\x05\x04\x01\x03\0\x01\x12\x03,\n\x1a\n\r\n\x06\x04\x01\x03\
    \0\x02\0\x12\x03-\x04\"\n\x0e\n\x07\x04\x01\x03\0\x02\0\x06\x12\x03-\x04\
    \x17\n\x0e\n\x07\x04\x01\x03\0\x02\0\x01\x12\x03-\x18\x1d\n\x0e\n\x07\
    \x04\x01\x03\0\x02\0\x03\x12\x03-\x20!\n\r\n\x06\x04\x01\x03\0\x02\x01\
    \x12\x03.\x04\x19\n\x0e\n\x07\x04\x01\x03\0\x02\x01\x05\x12\x03.\x04\n\n\
    \x0e\n\x07\x04\x01\x03\0\x02\x01\x01\x12\x03.\x0b\x14\n\x0e\n\x07\x04\
    \x01\x03\0\x02\x01\x03\x12\x03.\x17\x18\n\x0c\n\x04\x04\x01\x03\x01\x12\
    \x041\x025\x03\n\x0c\n\x05\x04\x01\x03\x01\x01\x12\x031\n\x18\n\r\n\x06\
    \x04\x01\x03\x01\x02\0\x12\x032\x04\"\n\x0e\n\x07\x04\x01\x03\x01\x02\0\
    \x06\x12\x032\x04\x17\n\x0e\n\x07\x04\x01\x03\x01\x02\0\x01\x12\x032\x18\
    \x1d\n\x0e\n\x07\x04\x01\x03\x01\x02\0\x03\x12\x032\x20!\n\r\n\x06\x04\
    \x01\x03\x01\x02\x01\x12\x033\x04\x19\n\x0e\n\x07\x04\x01\x03\x01\x02\
    \x01\x05\x12\x033\x04\n\n\x0e\n\x07\x04\x01\x03\x01\x02\x01\x01\x12\x033\
    \x0b\x14\n\x0e\n\x07\x04\x01\x03\x01\x02\x01\x03\x12\x033\x17\x18\n\r\n\
    \x06\x04\x01\x03\x01\x02\x02\x12\x034\x04(\n\x0e\n\x07\x04\x01\x03\x01\
    \x02\x02\x06\x12\x034\x04\x17\n\x0e\n\x07\x04\x01\x03\x01\x02\x02\x01\
    \x12\x034\x18#\n\x0e\n\x07\x04\x01\x03\x01\x02\x02\x03\x12\x034&'\n\x0c\
    \n\x04\x04\x01\x08\0\x12\x047\x02:\x03\n\x0c\n\x05\x04\x01\x08\0\x01\x12\
    \x037\x08\x13\n\x0b\n\x04\x04\x01\x02\0\x12\x038\x04,\n\x0c\n\x05\x04\
    \x01\x02\0\x06\x12\x038\x04\x14\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x038\
    \x15'\n\x0c\n\x05\x04\x01\x02\0\x03\x12\x038*+\n\x0b\n\x04\x04\x01\x02\
    \x01\x12\x039\x04(\n\x0c\n\x05\x04\x01\x02\x01\x06\x12\x039\x04\x12\n\
    \x0c\n\x05\x04\x01\x02\x01\x01\x12\x039\x13#\n\x0c\n\x05\x04\x01\x02\x01\
    \x03\x12\x039&'\n\xbb\x01\n\x02\x04\x02\x12\x04?\0R\x01\x1a\xae\x01\x20T\
    his\x20is\x20sent\x20both\x20in\x20the\x20initial\x20handshake\x20as\x20\
    well\x20as\x20mid-stream\x20if\x20any\x20of\x20the\x20attributes\x20have\
    \n\x20changed.\x20The\x20handshake\x20will\x20fill\x20in\x20all\x20value\
    s\x20as\x20part\x20of\x20an\x20initial\x20update.\n\n\n\n\x03\x04\x02\
    \x01\x12\x03?\x08\x1a\n\x0c\n\x04\x04\x02\x03\0\x12\x04@\x02E\x03\n\x0c\
    \n\x05\x04\x02\x03\0\x01\x12\x03@\n\x18\n7\n\x06\x04\x02\x03\0\x02\0\x12\
    \x03B\x04\x1a\x1a(\x20The\x20session\x20ID\x20of\x20the\x20started\x20se\
    ssion.\n\n\x0e\n\x07\x04\x02\x03\0\x02\0\x05\x12\x03B\x04\n\n\x0e\n\x07\
    \x04\x02\x03\0\x02\0\x01\x12\x03B\x0b\x15\n\x0e\n\x07\x04\x02\x03\0\x02\
    \0\x03\x12\x03B\x18\x19\n/\n\x06\x04\x02\x03\0\x02\x01\x12\x03D\x04-\x1a\
    \x20\x20The\x20start\x20time\x20of\x20the\x20session.\n\n\x0e\n\x07\x04\
    \x02\x03\0\x02\x01\x06\x12\x03D\x04\x1d\n\x0e\n\x07\x04\x02\x03\0\x02\
    \x01\x01\x12\x03D\x1e(\n\x0e\n\x07\x04\x02\x03\0\x02\x01\x03\x12\x03D+,\
    \n\x0c\n\x04\x04\x02\x03\x01\x12\x04G\x02K\x03\n\x0c\n\x05\x04\x02\x03\
    \x01\x01\x12\x03G\n\x1c\n\xbc\x01\n\x06\x04\x02\x03\x01\x02\0\x12\x03J\
    ...
    \n\n\x0e\n\x07\x04\x02\x03\x01\x02\0\x04\x12\x03J\x04\x0c\n\x0e\n\x07\
    \x04\x02\x03\x01\x02\0\x05\x12\x03J\r\x13\n\x0e\n\x07\x04\x02\x03\x01\
    \x02\0\x01\x12\x03J\x14$\n\x0e\n\x07\x04\x02\x03\x01\x02\0\x03\x12\x03J'\
    (\n(\n\x04\x04\x02\x02\0\x12\x03N\x02.\x1a\x1b\x20The\x20opaque\x20entit\
    y\x20update.\n\n\x0c\n\x05\x04\x02\x02\0\x06\x12\x03N\x02\x14\n\x0c\n\
    \x05\x04\x02\x02\0\x01\x12\x03N\x15)\n\x0c\n\x05\x04\x02\x02\0\x03\x12\
    \x03N,-\n,\n\x04\x04\x02\x02\x01\x12\x03Q\x02/\x1a\x1f\x20The\x20list\
    \x20of\x20started\x20sessions.\n\n\x0c\n\x05\x04\x02\x02\x01\x04\x12\x03\
    Q\x02\n\n\x0c\n\x05\x04\x02\x02\x01\x06\x12\x03Q\x0b\x19\n\x0c\n\x05\x04\
    \x02\x02\x01\x01\x12\x03Q\x1a*\n\x0c\n\x05\x04\x02\x02\x01\x03\x12\x03Q-\
    .\n8\n\x02\x04\x03\x12\x05U\0\x9b\x01\x01\x1a+\x20The\x20initial\x20requ\
    est\x20sent\x20over\x20the\x20stream.\n\n\n\n\x03\x04\x03\x01\x12\x03U\
    \x08\x18\ni\n\x04\x04\x03\x03\0\x12\x04W\x02k\x03\x1a[\x20Connection\x20\
    and\x20stats\x20pipeline\x20analytics\x20that\x20are\x20independent\x20o\
    f\x20the\x20stats\x20payload\x20itself.\n\n\x0c\n\x05\x04\x03\x03\0\x01\
    \x12\x03W\n\x13\n\xa6\x01\n\x06\x04\x03\x03\0\x03\0\x12\x04Z\x04a\x05\
    \x1a\x95\x01\x20A\x20durable\x20stats-pipeline\x20analytics\x20report.\
    \x20The\x20client\x20resends\x20it\x20until\x20the\x20server\x20accepts\
    \n\x20its\x20stable\x20ID,\x20then\x20starts\x20accumulating\x20the\x20n\
    ext\x20report.\n\n\x0e\n\x07\x04\x03\x03\0\x03\0\x01\x12\x03Z\x0c(\nU\n\
    \x08\x04\x03\x03\0\x03\0\x02\0\x12\x03\\\x06\x1b\x1aD\x20Stable\x20ID\
    \x20used\x20by\x20the\x20server\x20to\x20deduplicate\x20this\x20ACK-rese\
    t\x20report.\n\n\x10\n\t\x04\x03\x03\0\x03\0\x02\0\x05\x12\x03\\\x06\x0c\
    \n\x10\n\t\x04\x03\x03\0\x03\0\x02\0\x01\x12\x03\\\r\x16\n\x10\n\t\x04\
    \x03\x03\0\x03\0\x02\0\x03\x12\x03\\\x19\x1a\n\xb0\x01\n\x08\x04\x03\x03\
    \0\x03\0\x02\x01\x12\x03`\x06+\x1a\x9e\x01\x20The\x20ACK-reset\x20counte\
    rs\x20for\x20this\x20report.\x20This\x20is\x20also\x20the\x20durable\x20\
    on-disk\x20representation,\n\x20so\x20storage\x20and\x20the\x20handshake\
    \x20cannot\x20diverge\x20as\x20counters\x20are\x20added.\n\n\x10\n\t\x04\
    \x03\x03\0\x03\0\x02\x01\x06\x12\x03`\x06\x1c\n\x10\n\t\x04\x03\x03\0\
    \x03\0\x02\x01\x01\x12\x03`\x1d&\n\x10\n\t\x04\x03\x03\0\x03\0\x02\x01\
    \x03\x12\x03`)*\n\xdb\x01\n\x06\x04\x03\x03\0\x02\0\x12\x03f\x044\x1a\
    \xcb\x01\x20The\x20logical\x20connection\x20number\x20since\x20this\x20c\
    lient\x20process\x20started.\x20It\x20starts\x20at\x20one,\x20advances\n\
    \x20only\x20after\x20the\x20prior\x20handshake\x20receives\x20a\x20hands\
    hake\x20response,\x20and\x20is\x20not\x20persisted\x20across\n\x20proces\
    s\x20restarts.\n\n\x0e\n\x07\x04\x03\x03\0\x02\0\x05\x12\x03f\x04\n\n\
    \x0e\n\x07\x04\x03\x03\0\x02\0\x01\x12\x03f\x0b/\n\x0e\n\x07\x04\x03\x03\
    \0\x02\0\x03\x12\x03f23\n\xc1\x01\n\x06\x04\x03\x03\0\x02\x01\x12\x03j\
    \x044\x1a\xb1\x01\x20Durable\x20ACK-reset\x20stats\x20pipeline\x20analyt\
    ics.\x20The\x20server\x20must\x20deduplicate\x20report_id\x20before\n\
    \x20adding\x20the\x20counters\x20to\x20its\x20totals\x20and\x20echo\x20t\
    he\x20ID\x20in\x20HandshakeResponse\x20when\x20accepted.\n\n\x0e\n\x07\
    \x04\x03\x03\0\x02\x01\x06\x12\x03j\x04\x20\n\x0e\n\x07\x04\x03\x03\0\
    \x02\x01\x01\x12\x03j!/\n\x0e\n\x07\x04\x03\x03\0\x02\x01\x03\x12\x03j23\
    \n\xe4\x01\n\x04\x04\x03\x02\0\x12\x03p\x02:\x1a\xd6\x01\x20A\x20set\x20\
    ...
    uest.\n\n\x0c\n\x05\x04\x03\x02\0\x06\x12\x03p\x02\x1e\n\x0c\n\x05\x04\
    \x03\x02\0\x01\x12\x03p\x1f5\n\x0c\n\x05\x04\x03\x02\0\x03\x12\x03p89\n\
    \n\n\x03\x04\x03\t\x12\x03r\x02\r\n\x0b\n\x04\x04\x03\t\0\x12\x03r\x0b\
    \x0c\n\x0c\n\x05\x04\x03\t\0\x01\x12\x03r\x0b\x0c\n\x0c\n\x05\x04\x03\t\
    \0\x02\x12\x03r\x0b\x0c\n\xab\x02\n\x04\x04\x03\x02\x01\x12\x03x\x02)\
    ...
    ty.\n\n\x0c\n\x05\x04\x03\x02\x01\x05\x12\x03x\x02\x08\n\x0c\n\x05\x04\
    \x03\x02\x01\x01\x12\x03x\t$\n\x0c\n\x05\x04\x03\x02\x01\x03\x12\x03x'(\
    \n\x93\x02\n\x04\x04\x03\x02\x02\x12\x03~\x02#\x1a\x85\x02\x20If\x20the\
    ...
    \x03\x02\x02\x03\x12\x03~!\"\n\x0b\n\x03\x04\x03\t\x12\x04\x80\x01\x02\r\
    \n\x0c\n\x04\x04\x03\t\x01\x12\x04\x80\x01\x0b\x0c\n\r\n\x05\x04\x03\t\
    \x01\x01\x12\x04\x80\x01\x0b\x0c\n\r\n\x05\x04\x03\t\x01\x02\x12\x04\x80\
    \x01\x0b\x0c\n\x98\x01\n\x04\x04\x03\x02\x03\x12\x04\x84\x01\x02(\x1a\
    \x89\x01\x20Reports\x20the\x20reason,\x20if\x20any,\x20that\x20the\x20cl\
    ient\x20was\x20previously\x20disconnected\x20from\x20the\x20server.\x20T\
    his\n\x20is\x20useful\x20for\x20debugging\x20reconnect\x20loops.\n\n\r\n\
    \x05\x04\x03\x02\x03\x05\x12\x04\x84\x01\x02\x08\n\r\n\x05\x04\x03\x02\
    \x03\x01\x12\x04\x84\x01\t#\n\r\n\x05\x04\x03\x02\x03\x03\x12\x04\x84\
    \x01&'\n\\\n\x04\x04\x03\x02\x04\x12\x04\x87\x01\x02\x16\x1aN\x20At\x20t\
    he\x20time\x20of\x20the\x20handshake,\x20whether\x20the\x20client\x20is\
    \x20operating\x20in\x20sleep\x20mode.\n\n\r\n\x05\x04\x03\x02\x04\x05\
    \x12\x04\x87\x01\x02\x06\n\r\n\x05\x04\x03\x02\x04\x01\x12\x04\x87\x01\
    \x07\x11\n\r\n\x05\x04\x03\x02\x04\x03\x12\x04\x87\x01\x14\x15\n\xf7\x01\
    \n\x04\x04\x03\x02\x05\x12\x04\x8c\x01\x02)\x1a\xe8\x01\x20Opaque\x20cli\
    ent\x20state\x20previously\x20provided\x20by\x20the\x20server\x20in\x20a\
    ...
    \x04\x12\x04\x8c\x01\x02\n\n\r\n\x05\x04\x03\x02\x05\x05\x12\x04\x8c\x01\
    \x0b\x10\n\r\n\x05\x04\x03\x02\x05\x01\x12\x04\x8c\x01\x11$\n\r\n\x05\
    \x04\x03\x02\x05\x03\x12\x04\x8c\x01'(\n\xbf\x02\n\x04\x04\x03\x02\x06\
    \x12\x04\x92\x01\x02&\x1a\xb0\x02\x20When\x20the\x20handshake\x20request\
    \x20is\x20sent\x20an\x20initial\x20state\x20update\x20will\x20be\x20incl\
    uded\x20with\x20both\n\x20the\x20opaque\x20entity\x20ID\x20(if\x20provid\
    ed)\x20as\x20well\x20as\x20at\x20least\x20the\x20current\x20session.\x20\
    There\x20may\x20be\n\x20multiple\x20sessions\x20included\x20if\x20some\
    \x20session\x20transitions\x20have\x20happened\x20while\x20offline\x20an\
    d\x20have\n\x20not\x20yet\x20been\x20sent\x20to\x20the\x20server.\n\n\r\
    \n\x05\x04\x03\x02\x06\x06\x12\x04\x92\x01\x02\x14\n\r\n\x05\x04\x03\x02\
    \x06\x01\x12\x04\x92\x01\x15!\n\r\n\x05\x04\x03\x02\x06\x03\x12\x04\x92\
    \x01$%\n8\n\x04\x04\x03\x02\x07\x12\x04\x95\x01\x02\x1b\x1a*\x20Connecti\
    on\x20and\x20stats\x20pipeline\x20analytics.\n\n\r\n\x05\x04\x03\x02\x07\
    \x06\x12\x04\x95\x01\x02\x0b\n\r\n\x05\x04\x03\x02\x07\x01\x12\x04\x95\
    \x01\x0c\x15\n\r\n\x05\x04\x03\x02\x07\x03\x12\x04\x95\x01\x18\x1a\n\x8c\
    \x02\n\x04\x04\x03\x02\x08\x12\x04\x9a\x01\x02/\x1a\xfd\x01\x20A\x20pend\
    ing\x20stats\x20upload\x20selected\x20during\x20client\x20initialization\
    .\x20The\x20server\x20acknowledges\x20it\x20in\x20a\n\x20StatsUploadResp\
    onse\x20after\x20the\x20handshake,\x20allowing\x20the\x20client\x20to\
    \x20avoid\x20an\x20additional\n\x20request/response\x20round\x20trip\x20\
    before\x20deleting\x20the\x20persisted\x20source\x20files.\n\n\r\n\x05\
    \x04\x03\x02\x08\x06\x12\x04\x9a\x01\x02\x14\n\r\n\x05\x04\x03\x02\x08\
    \x01\x12\x04\x9a\x01\x15)\n\r\n\x05\x04\x03\x02\x08\x03\x12\x04\x9a\x01,\
    .\n\xc8\x03\n\x02\x04\x04\x12\x06\xa2\x01\0\xc7\x01\x01\x1a\xb9\x03\x20N\
    otifies\x20the\x20server\x20about\x20the\x20intent\x20to\x20upload\x20on\
    e\x20or\x20more\x20batches\x20of\x20logs.\x20The\x20client\x20is\x20expe\
    cted\x20(but\n\x20not\x20required,\x20for\x20backwards\x20compatibility)\
    \x20to\x20notify\x20the\x20server\x20about\x20the\x20intent\x20to\x20upl\
    oad\n\x20before\x20uploading.\x20The\x20server\x20is\x20thusly\x20able\
    \x20to\x20influence\x20whether\x20the\x20client\n\x20actually\x20uploads\
    \x20(e.g.\x20the\x20backend\x20no\x20longer\x20wants\x20more\x20of\x20th\
    ese\x20kind\x20of\x20logs)\n\x20or\x20delay\x20the\x20upload\x20(e.g.\
    \x20we\x20are\x20hitting\x20rate\x20limits\x20and\x20are\x20applying\x20\
    back-pressure).\n\n\x0b\n\x03\x04\x04\x01\x12\x04\xa2\x01\x08\x1e\n\x9d\
    \x01\n\x04\x04\x04\x02\0\x12\x04\xa5\x01\x02\x17\x1a\x8e\x01\x20The\x20n\
    umber\x20of\x20logs\x20that\x20the\x20client\x20wants\x20to\x20upload.\
    \x20Note\x20that\x20for\x20a\x20ListenerUpload\x20this\x20is\n\x20an\x20\
    approximation\x20of\x20all\x20logs\x20across\x20all\x20batches.\n\n\r\n\
    \x05\x04\x04\x02\0\x05\x12\x04\xa5\x01\x02\x08\n\r\n\x05\x04\x04\x02\0\
    \x01\x12\x04\xa5\x01\t\x12\n\r\n\x05\x04\x04\x02\0\x03\x12\x04\xa5\x01\
    \x15\x16\n\xa0\x01\n\x04\x04\x04\x02\x01\x12\x04\xa9\x01\x02\x18\x1a\x91\
    \x01\x20The\x20size\x20of\x20the\x20intended\x20upload,\x20in\x20bytes.\
    \x20Note\x20that\x20for\x20a\x20ListenerUpload\x20this\x20is\n\x20an\x20\
    approximation\x20of\x20the\x20size\x20of\x20all\x20logs\x20across\x20all\
    \x20batches.\n\n\r\n\x05\x04\x04\x02\x01\x05\x12\x04\xa9\x01\x02\x08\n\r\
    \n\x05\x04\x04\x02\x01\x01\x12\x04\xa9\x01\t\x13\n\r\n\x05\x04\x04\x02\
    \x01\x03\x12\x04\xa9\x01\x16\x17\n8\n\x04\x04\x04\x02\x02\x12\x04\xac\
    \x01\x02\x17\x1a*\x20The\x20buffer\x20these\x20logs\x20are\x20uploaded\
    \x20from.\n\n\r\n\x05\x04\x04\x02\x02\x05\x12\x04\xac\x01\x02\x08\n\r\n\
    \x05\x04\x04\x02\x02\x01\x12\x04\xac\x01\t\x12\n\r\n\x05\x04\x04\x02\x02\
    \x03\x12\x04\xac\x01\x15\x16\n\xd7\x01\n\x04\x04\x04\x02\x03\x12\x04\xb1\
    \x01\x02\x19\x1a\xc8\x01\x20The\x20client\x20generated\x20UUID\x20for\
    \x20this\x20intent.\x20This\x20allows\x20the\x20server\x20to\x20enforce\
    \x20idempotence\n\x20during\x20intent\x20negotiation\x20as\x20well\x20as\
    \x20allowing\x20for\x20parallel\x20intent\x20requests\x20to\x20be\x20res\
    ponded\n\x20to\x20out\x20of\x20order.\n\n\r\n\x05\x04\x04\x02\x03\x05\
    \x12\x04\xb1\x01\x02\x08\n\r\n\x05\x04\x04\x02\x03\x01\x12\x04\xb1\x01\t\
    \x14\n\r\n\x05\x04\x04\x02\x03\x03\x12\x04\xb1\x01\x17\x18\n\x90\x01\n\
    \x04\x04\x04\x02\x04\x12\x04\xb5\x01\x02\x18\x1a\x81\x01\x20The\x20sessi\
    on\x20ID\x20of\x20the\x20log\x20that\x20caused\x20the\x20intent\x20negot\
    iation.\x20This\x20allows\x20correlating\x20the\x20intent\x20with\n\x20a\
    \x20specific\x20user\x20session.\n\n\r\n\x05\x04\x04\x02\x04\x05\x12\x04\
    \xb5\x01\x02\x08\n\r\n\x05\x04\x04\x02\x04\x01\x12\x04\xb5\x01\t\x13\n\r\
    \n\x05\x04\x04\x02\x04\x03\x12\x04\xb5\x01\x16\x17\n\x0e\n\x04\x04\x04\
    \x03\0\x12\x06\xb7\x01\x02\xba\x01\x03\n\r\n\x05\x04\x04\x03\0\x01\x12\
    \x04\xb7\x01\n\x1e\n>\n\x06\x04\x04\x03\0\x02\0\x12\x04\xb9\x01\x04,\x1a\
    .\x20The\x20listener(s)\x20which\x20triggered\x20this\x20upload.\n\n\x0f\
    \n\x07\x04\x04\x03\0\x02\0\x04\x12\x04\xb9\x01\x04\x0c\n\x0f\n\x07\x04\
    \x04\x03\0\x02\0\x05\x12\x04\xb9\x01\r\x13\n\x0f\n\x07\x04\x04\x03\0\x02\
    \0\x01\x12\x04\xb9\x01\x14'\n\x0f\n\x07\x04\x04\x03\0\x02\0\x03\x12\x04\
    \xb9\x01*+\n\x0e\n\x04\x04\x04\x03\x01\x12\x06\xbc\x01\x02\xbf\x01\x03\n\
    \r\n\x05\x04\x04\x03\x01\x01\x12\x04\xbc\x01\n\x20\nc\n\x06\x04\x04\x03\
    \x01\x02\0\x12\x04\xbe\x01\x04;\x1aS\x20An\x20opaque\x20identifier\x20th\
    at\x20is\x20used\x20to\x20identify\x20the\x20reason\x20for\x20the\x20ses\
    sion\x20capture.\n\n\x0f\n\x07\x04\x04\x03\x01\x02\0\x05\x12\x04\xbe\x01\
    \x04\n\n\x0f\n\x07\x04\x04\x03\x01\x02\0\x01\x12\x04\xbe\x01\x0b\r\n\x0f\
    \n\x07\x04\x04\x03\x01\x02\0\x03\x12\x04\xbe\x01\x10\x11\n\x0f\n\x07\x04\
    \x04\x03\x01\x02\0\x08\x12\x04\xbe\x01\x12:\n\x12\n\n\x04\x04\x03\x01\
    \x02\0\x08\xaf\x08\x0e\x12\x04\xbe\x01\x139\n\x0e\n\x04\x04\x04\x08\0\
    \x12\x06\xc1\x01\x02\xc6\x01\x03\n\r\n\x05\x04\x04\x08\0\x01\x12\x04\xc1\
    \x01\x08\x13\n\x0c\n\x04\x04\x04\x02\x05\x12\x04\xc2\x01\x044\n\r\n\x05\
    \x04\x04\x02\x05\x06\x12\x04\xc2\x01\x04\x18\n\r\n\x05\x04\x04\x02\x05\
    \x01\x12\x04\xc2\x01\x19/\n\r\n\x05\x04\x04\x02\x05\x03\x12\x04\xc2\x012\
    3\nG\n\x04\x04\x04\x02\x06\x12\x04\xc5\x01\x048\x1a9\x20Session\x20captu\
    re\x20was\x20explicitly\x20triggered\x20by\x20the\x20client.\n\n\r\n\x05\
    \x04\x04\x02\x06\x06\x12\x04\xc5\x01\x04\x1a\n\r\n\x05\x04\x04\x02\x06\
    \x01\x12\x04\xc5\x01\x1b3\n\r\n\x05\x04\x04\x02\x06\x03\x12\x04\xc5\x016\
    7\n\x0c\n\x02\x04\x05\x12\x06\xc9\x01\0\xda\x01\x01\n\x0b\n\x03\x04\x05\
    \x01\x12\x04\xc9\x01\x08\x1f\n8\n\x04\x04\x05\x02\0\x12\x04\xcb\x01\x02\
    \x19\x1a*\x20The\x20UUID\x20of\x20the\x20intent\x20being\x20negotiated.\
    \n\n\r\n\x05\x04\x05\x02\0\x05\x12\x04\xcb\x01\x02\x08\n\r\n\x05\x04\x05\
    \x02\0\x01\x12\x04\xcb\x01\t\x14\n\r\n\x05\x04\x05\x02\0\x03\x12\x04\xcb\
    \x01\x17\x18\n\x0c\n\x04\x04\x05\x03\0\x12\x04\xcd\x01\x02\x1e\n\r\n\x05\
    \x04\x05\x03\0\x01\x12\x04\xcd\x01\n\x1b\na\n\x04\x04\x05\x03\x01\x12\
    \x06\xcf\x01\x02\xd1\x01\x03\"Q\x20If\x20the\x20upload\x20intent\x20was\
    \x20a\x20ListenerUpload\x20the\x20entire\x20upload\x20should\x20be\x20ca\
    nceled.\n\n\r\n\x05\x04\x05\x03\x01\x01\x12\x04\xcf\x01\n\x0e\n\x0e\n\
    \x04\x04\x05\x08\0\x12\x06\xd3\x01\x02\xd9\x01\x03\n\r\n\x05\x04\x05\x08\
    \0\x01\x12\x04\xd3\x01\x08\x10\n7\n\x04\x04\x05\x02\x01\x12\x04\xd5\x01\
    \x04-\x1a)\x20The\x20log\x20should\x20be\x20uploaded\x20immediately.\n\n\
    \r\n\x05\x04\x05\x02\x01\x06\x12\x04\xd5\x01\x04\x15\n\r\n\x05\x04\x05\
    \x02\x01\x01\x12\x04\xd5\x01\x16(\n\r\n\x05\x04\x05\x02\x01\x03\x12\x04\
    \xd5\x01+,\n6\n\x04\x04\x05\x02\x02\x12\x04\xd8\x01\x04\x12\x1a(\x20The\
    ...
    be\x20generated\x20by\x20the\n\x20client.\x20Retries\x20should\x20use\
    \x20the\x20same\x20upload_id.\n\n\r\n\x05\x04\x06\x02\0\x05\x12\x04\xe0\
    \x01\x02\x08\n\r\n\x05\x04\x06\x02\0\x01\x12\x04\xe0\x01\t\x14\n\r\n\x05\
    \x04\x06\x02\0\x03\x12\x04\xe0\x01\x17\x18\n\r\n\x05\x04\x06\x02\0\x08\
    \x12\x04\xe0\x01\x19A\n\x10\n\x08\x04\x06\x02\0\x08\xaf\x08\x0e\x12\x04\
    \xe0\x01\x1a@\n\xda\x01\n\x04\x04\x06\x02\x01\x12\x04\xe5\x01\x02,\x1a\
    \xcb\x01\x20A\x20repeated\x20set\x20of\x20flatbuffer\x20encoding\x20of\
    \x20a\x20number\x20of\x20log\x20lines.\x20Each\x20log\x20line\x20is\x20o\
    f\x20type\n\x20Log\x20defined\x20in\x20buffer_log.fbs.\x20This\x20is\x20\
    deprecated.\x20New\x20clients\x20send\x20protobuf\x20encoded\x20logs\n\
    \x20in\x20the\x20'logs'\x20field.\n\n\r\n\x05\x04\x06\x02\x01\x04\x12\
    \x04\xe5\x01\x02\n\n\r\n\x05\x04\x06\x02\x01\x05\x12\x04\xe5\x01\x0b\x10\
    \n\r\n\x05\x04\x06\x02\x01\x01\x12\x04\xe5\x01\x11'\n\r\n\x05\x04\x06\
    \x02\x01\x03\x12\x04\xe5\x01*+\nO\n\x04\x04\x06\x02\x02\x12\x04\xe8\x01\
    \x02\x20\x1aA\x20Logs\x20encoded\x20in\x20bitdrift_public.protobuf.loggi\
    ng.v1.Log\x20format.\n\n\r\n\x05\x04\x06\x02\x02\x04\x12\x04\xe8\x01\x02\
    \n\n\r\n\x05\x04\x06\x02\x02\x05\x12\x04\xe8\x01\x0b\x10\n\r\n\x05\x04\
    \x06\x02\x02\x01\x12\x04\xe8\x01\x11\x1b\n\r\n\x05\x04\x06\x02\x02\x03\
    \x12\x04\xe8\x01\x1e\x1f\nG\n\x04\x04\x06\x02\x03\x12\x04\xeb\x01\x02B\
    \x1a9\x20The\x20UUID\x20(v4)\x20of\x20the\x20buffer\x20that\x20is\x20pro\
    ducing\x20the\x20logs.\n\n\r\n\x05\x04\x06\x02\x03\x05\x12\x04\xeb\x01\
    \x02\x08\n\r\n\x05\x04\x06\x02\x03\x01\x12\x04\xeb\x01\t\x14\n\r\n\x05\
    \x04\x06\x02\x03\x03\x12\x04\xeb\x01\x17\x18\n\r\n\x05\x04\x06\x02\x03\
    \x08\x12\x04\xeb\x01\x19A\n\x10\n\x08\x04\x06\x02\x03\x08\xaf\x08\x0e\
    \x12\x04\xeb\x01\x1a@\n\xdc\x07\n\x04\x04\x06\x02\x04\x12\x04\xfd\x01\
    \x02$\x1a\xcd\x07\x20Stable\x20identifiers\x20for\x20the\x20logical\x20t\
    rigger\x20instances\x20that\x20caused\x20this\x20upload.\n\n\x20Current\
    \x20client\x20behavior\x20sends\x20either\x20zero\x20or\x20one\x20entrie\
    s:\n\x201.\x20zero\x20entries\x20for\x20uploads\x20that\x20did\x20not\
    \x20come\x20from\x20intent-negotiated\x20trigger\x20flushing,\x20such\n\
    \x20\x20\x20\x20as\x20continuous\x20uploads,\x20post-trigger\x20streamin\
    g\x20uploads,\x20and\x20remote-command-triggered\x20flush\n\x20\x20\x20\
    \x20uploads\n\x202.\x20one\x20entry\x20for\x20the\x20original\x20trigger\
    \x20upload\x20that\x20first\x20completed\x20intent\x20negotiation\n\n\
    \x20If\x20one\x20log\x20matches\x20multiple\x20flush\x20actions,\x20the\
    \x20client\x20is\x20expected\x20to\x20reuse\x20one\x20shared\x20trigger\
    \n\x20UUID\x20across\x20all\x20of\x20the\x20resulting\x20intent\x20negot\
    iations\x20for\x20that\x20triggering\x20log/event.\x20Logger-\n\x20side\
    \x20active-buffer\x20suppression\x20may\x20still\x20collapse\x20the\x20r\
    esulting\x20work\x20into\x20one\x20concrete\x20upload\n\x20for\x20the\
    \x20buffer,\x20and\x20that\x20upload\x20carries\x20that\x20same\x20share\
    d\x20UUID.\n\n\x20The\x20field\x20is\x20repeated\x20to\x20future-proof\
    \x20the\x20wire\x20contract\x20in\x20case\x20a\x20future\x20client\x20re\
    vision\n\x20needs\x20one\x20concrete\x20upload\x20to\x20represent\x20mor\
    e\x20than\x20one\x20accepted\x20trigger\x20instance.\x20That\x20does\x20\
    not\n\x20happen\x20today.\n\n\r\n\x05\x04\x06\x02\x04\x04\x12\x04\xfd\
    \x01\x02\n\n\r\n\x05\x04\x06\x02\x04\x05\x12\x04\xfd\x01\x0b\x11\n\r\n\
    \x05\x04\x06\x02\x04\x01\x12\x04\xfd\x01\x12\x1f\n\r\n\x05\x04\x06\x02\
    \x04\x03\x12\x04\xfd\x01\"#\n\xc8\x01\n\x04\x04\x06\x02\x05\x12\x04\x82\
    \x02\x02\x13\x1a\xb9\x01\x20Whether\x20the\x20server\x20should\x20not\
    \x20respond\x20to\x20this\x20upload.\x20This\x20is\x20used\x20for\x20hig\
    h\n\x20throughput,\x20low\x20value\x20logs\x20where\x20the\x20client\x20\
    ...
    \x20server\x20make\x20a\x20decision\x20about\x20whether\x20to\x20accept\
    ...
    \0\x12\x06\x8c\x03\0\x92\x03\x01\n\x0b\n\x03\x05\0\x01\x12\x04\x8c\x03\
    \x05\x1c\n<\n\x04\x05\0\x02\0\x12\x04\x8e\x03\x02$\x1a.\x20The\x20reques\
    t\x20contains\x20logical\x20artifact\x20bytes.\n\n\r\n\x05\x05\0\x02\0\
    \x01\x12\x04\x8e\x03\x02\x1f\n\r\n\x05\x05\0\x02\0\x02\x12\x04\x8e\x03\"\
    #\nD\n\x04\x05\0\x02\x01\x12\x04\x91\x03\x02%\x1a6\x20The\x20request\x20\
    contains\x20zlib-compressed\x20artifact\x20bytes.\n\n\r\n\x05\x05\0\x02\
    \x01\x01\x12\x04\x91\x03\x02\x20\n\r\n\x05\x05\0\x02\x01\x02\x12\x04\x91\
    \x03#$\n\x0c\n\x02\x04\x0e\x12\x06\x94\x03\0\xb9\x03\x01\n\x0b\n\x03\x04\
    \x0e\x01\x12\x04\x94\x03\x08\x1d\nf\n\x04\x04\x0e\x02\0\x12\x04\x96\x03\
    ...
    \r\n\x05\x04\x0e\x02\0\x05\x12\x04\x96\x03\x02\x08\n\r\n\x05\x04\x0e\x02\
    \0\x01\x12\x04\x96\x03\t\x14\n\r\n\x05\x04\x0e\x02\0\x03\x12\x04\x96\x03\
    \x17\x18\n\r\n\x05\x04\x0e\x02\0\x08\x12\x04\x96\x03\x19A\n\x10\n\x08\
    \x04\x0e\x02\0\x08\xaf\x08\x0e\x12\x04\x96\x03\x1a@\n8\n\x04\x04\x0e\x02\
    \x01\x12\x04\x99\x03\x02>\x1a*\x20The\x20type\x20of\x20the\x20artifact\
    \x20being\x20uploaded.\n\n\r\n\x05\x04\x0e\x02\x01\x05\x12\x04\x99\x03\
    \x02\x08\n\r\n\x05\x04\x0e\x02\x01\x01\x12\x04\x99\x03\t\x10\n\r\n\x05\
    \x04\x0e\x02\x01\x03\x12\x04\x99\x03\x13\x14\n\r\n\x05\x04\x0e\x02\x01\
    \x08\x12\x04\x99\x03\x15=\n\x10\n\x08\x04\x0e\x02\x01\x08\xaf\x08\x0e\
    \x12\x04\x99\x03\x16<\nu\n\x04\x04\x0e\x02\x02\x12\x04\x9c\x03\x02\x15\
    \x1ag\x20The\x20artifact\x20to\x20upload.\x20This\x20is\x20a\x20binary\
    \x20blob\x20that\x20is\x20interpreted\x20by\x20the\x20server\x20based\
    \x20on\x20the\x20type_id.\n\n\r\n\x05\x04\x0e\x02\x02\x05\x12\x04\x9c\
    \x03\x02\x07\n\r\n\x05\x04\x0e\x02\x02\x01\x12\x04\x9c\x03\x08\x10\n\r\n\
    \x05\x04\x0e\x02\x02\x03\x12\x04\x9c\x03\x13\x14\n\xa1\x01\n\x04\x04\x0e\
    \x02\x03\x12\x04\xa0\x03\x02B\x1a\x92\x01\x20A\x20client-generated\x20ID\
    \x20that\x20uniquely\x20identifies\x20the\x20artifact\x20being\x20upload\
    ed.\x20This\x20is\x20used\x20to\x20correlate\n\x20the\x20artifact\x20wit\
    h\x20logs\x20that\x20reference\x20it.\n\n\r\n\x05\x04\x0e\x02\x03\x05\
    \x12\x04\xa0\x03\x02\x08\n\r\n\x05\x04\x0e\x02\x03\x01\x12\x04\xa0\x03\t\
    \x14\n\r\n\x05\x04\x0e\x02\x03\x03\x12\x04\xa0\x03\x17\x18\n\r\n\x05\x04\
    \x0e\x02\x03\x08\x12\x04\xa0\x03\x19A\n\x10\n\x08\x04\x0e\x02\x03\x08\
    \xaf\x08\x0e\x12\x04\xa0\x03\x1a@\n\xcb\x01\n\x04\x04\x0e\x02\x04\x12\
    \x04\xa4\x03\x022\x1a\xbc\x01\x20An\x20optional\x20set\x20of\x20key-valu\
    e\x20data\x20indicating\x20the\x20state\x20of\x20the\x20device\x20at\x20\
    the\x20time\x20of\x20artifact\x20emission.\x20For\x20example,\n\x20this\
    \x20may\x20capture\x20information\x20about\x20the\x20device\x20at\x20the\
    \x20time\x20of\x20a\x20crash.\n\n\r\n\x05\x04\x0e\x02\x04\x06\x12\x04\
    \xa4\x03\x02\x1e\n\r\n\x05\x04\x0e\x02\x04\x01\x12\x04\xa4\x03\x1f-\n\r\
    \n\x05\x04\x0e\x02\x04\x03\x12\x04\xa4\x0301\n~\n\x04\x04\x0e\x02\x05\
    \x12\x04\xa7\x03\x02S\x1ap\x20The\x20timestamp\x20associated\x20with\x20\
    this\x20upload.\x20This\x20allows\x20us\x20to\x20possibly\x20reject\x20t\
    he\x20upload\x20of\x20very\x20old\x20artifacts.\n\n\r\n\x05\x04\x0e\x02\
    \x05\x06\x12\x04\xa7\x03\x02\x1b\n\r\n\x05\x04\x0e\x02\x05\x01\x12\x04\
    \xa7\x03\x1c\x20\n\r\n\x05\x04\x0e\x02\x05\x03\x12\x04\xa7\x03#$\n\r\n\
    \x05\x04\x0e\x02\x05\x08\x12\x04\xa7\x03%R\n\x10\n\x08\x04\x0e\x02\x05\
    \x08\xaf\x08\x11\x12\x04\xa7\x03&Q\nJ\n\x04\x04\x0e\x02\x06\x12\x04\xaa\
    \x03\x02\x18\x1a<\x20The\x20session\x20ID\x20associated\x20with\x20the\
    \x20artifact\x20if\x20applicable.\n\n\r\n\x05\x04\x0e\x02\x06\x05\x12\
    \x04\xaa\x03\x02\x08\n\r\n\x05\x04\x0e\x02\x06\x01\x12\x04\xaa\x03\t\x13\
    \n\r\n\x05\x04\x0e\x02\x06\x03\x12\x04\xaa\x03\x16\x17\n[\n\x04\x04\x0e\
    \x02\x07\x12\x04\xad\x03\x02)\x1aM\x20The\x20set\x20of\x20feature\x20fla\
    gs\x20that\x20were\x20active\x20at\x20the\x20time\x20of\x20artifact\x20e\
    mission.\n\n\r\n\x05\x04\x0e\x02\x07\x04\x12\x04\xad\x03\x02\n\n\r\n\x05\
    \x04\x0e\x02\x07\x06\x12\x04\xad\x03\x0b\x16\n\r\n\x05\x04\x0e\x02\x07\
    \x01\x12\x04\xad\x03\x17$\n\r\n\x05\x04\x0e\x02\x07\x03\x12\x04\xad\x03'\
    (\n\xbe\x01\n\x04\x04\x0e\x02\x08\x12\x04\xb1\x03\x02I\x1a\xaf\x01\x20Cl\
    ient\x20workflow\x20continuations\x20that\x20should\x20be\x20evaluated\
    \x20when\x20this\x20report\x20is\x20processed.\n\x20Only\x20populated\
    \x20for\x20issue-report\x20artifacts;\x20other\x20artifact\x20types\x20m\
    ust\x20leave\x20this\x20unset.\n\n\r\n\x05\x04\x0e\x02\x08\x04\x12\x04\
    \xb1\x03\x02\n\n\r\n\x05\x04\x0e\x02\x08\x06\x12\x04\xb1\x03\x0b,\n\r\n\
    \x05\x04\x0e\x02\x08\x01\x12\x04\xb1\x03-D\n\r\n\x05\x04\x0e\x02\x08\x03\
    \x12\x04\xb1\x03GH\n\xc2\x01\n\x04\x04\x0e\x02\t\x12\x04\xb5\x03\x02H\
    \x1a\xb3\x01\x20The\x20remote\x20command\x20that\x20produced\x20this\x20\
    artifact.\x20Only\x20command-correlated\x20artifact\x20uploads\x20set\n\
    \x20this\x20field;\x20workflow\x20command\x20artifacts\x20remain\x20sess\
    ion\x20artifacts\x20and\x20leave\x20it\x20unset.\n\n\r\n\x05\x04\x0e\x02\
    \t\x04\x12\x04\xb5\x03\x02\n\n\r\n\x05\x04\x0e\x02\t\x05\x12\x04\xb5\x03\
    \x0b\x11\n\r\n\x05\x04\x0e\x02\t\x01\x12\x04\xb5\x03\x12\x1c\n\r\n\x05\
    \x04\x0e\x02\t\x03\x12\x04\xb5\x03\x1f!\n\r\n\x05\x04\x0e\x02\t\x08\x12\
    \x04\xb5\x03\"G\n\x11\n\t\x04\x0e\x02\t\x08\xaf\x08\x0e\x16\x12\x04\xb5\
    \x03#F\nm\n\x04\x04\x0e\x02\n\x12\x04\xb8\x03\x020\x1a_\x20The\x20encodi\
    ng\x20of\x20contents.\x20Only\x20workflow\x20and\x20direct\x20command\
    \x20attachments\x20may\x20use\x20zlib\x20encoding.\n\n\r\n\x05\x04\x0e\
    \x02\n\x06\x12\x04\xb8\x03\x02\x19\n\r\n\x05\x04\x0e\x02\n\x01\x12\x04\
    \xb8\x03\x1a*\n\r\n\x05\x04\x0e\x02\n\x03\x12\x04\xb8\x03-/\n\x0c\n\x02\
    \x04\x0f\x12\x06\xbb\x03\0\xc1\x03\x01\n\x0b\n\x03\x04\x0f\x01\x12\x04\
    \xbb\x03\x08\x1e\n=\n\x04\x04\x0f\x02\0\x12\x04\xbd\x03\x02B\x1a/\x20The\
    \x20UUID\x20corresponding\x20to\x20the\x20upload\x20request.\n\n\r\n\x05\
    \x04\x0f\x02\0\x05\x12\x04\xbd\x03\x02\x08\n\r\n\x05\x04\x0f\x02\0\x01\
    \x12\x04\xbd\x03\t\x14\n\r\n\x05\x04\x0f\x02\0\x03\x12\x04\xbd\x03\x17\
    \x18\n\r\n\x05\x04\x0f\x02\0\x08\x12\x04\xbd\x03\x19A\n\x10\n\x08\x04\
    \x0f\x02\0\x08\xaf\x08\x0e\x12\x04\xbd\x03\x1a@\nS\n\x04\x04\x0f\x02\x01\
    \x12\x04\xc0\x03\x02\x13\x1aE\x20Optional\x20error\x20message\x20which\
    \x20indicates\x20that\x20artifact\x20upload\x20failed.\n\n\r\n\x05\x04\
    \x0f\x02\x01\x05\x12\x04\xc0\x03\x02\x08\n\r\n\x05\x04\x0f\x02\x01\x01\
    \x12\x04\xc0\x03\t\x0e\n\r\n\x05\x04\x0f\x02\x01\x03\x12\x04\xc0\x03\x11\
    \x12\nB\n\x02\x04\x10\x12\x06\xc4\x03\0\xe7\x03\x01\x1a4\x20The\x20respo\
    nse\x20sent\x20as\x20part\x20of\x20stream\x20establishment.\n\n\x0b\n\
    \x03\x04\x10\x01\x12\x04\xc4\x03\x08\x19\n\x0e\n\x04\x04\x10\x03\0\x12\
    \x06\xc5\x03\x02\xc9\x03\x03\n\r\n\x05\x04\x10\x03\0\x01\x12\x04\xc5\x03\
    \n\x16\n\xb8\x01\n\x06\x04\x10\x03\0\x02\0\x12\x04\xc8\x03\x04\x19\x1a\
    \xa7\x01\x20The\x20analytics\x20report\x20ID\x20from\x20HandshakeRequest\
    .Analytics.StatsPipelineAnalytics\x20that\x20the\n\x20server\x20accepted\
    .\x20The\x20client\x20retains\x20the\x20report\x20until\x20this\x20ID\
    \x20is\x20echoed\x20back.\n\n\x0f\n\x07\x04\x10\x03\0\x02\0\x05\x12\x04\
    \xc8\x03\x04\n\n\x0f\n\x07\x04\x10\x03\0\x02\0\x01\x12\x04\xc8\x03\x0b\
    \x14\n\x0f\n\x07\x04\x10\x03\0\x02\0\x03\x12\x04\xc8\x03\x17\x18\n\x0e\n\
    \x04\x04\x10\x03\x01\x12\x06\xcb\x03\x02\xd1\x03\x03\n\r\n\x05\x04\x10\
    \x03\x01\x01\x12\x04\xcb\x03\n\x18\n\xe2\x01\n\x06\x04\x10\x03\x01\x02\0\
    \x12\x04\xd0\x03\x04/\x1a\xd1\x01\x20How\x20often\x20the\x20client\x20sh\
    ould\x20ping\x20the\x20server.\x20This\x20informs\x20the\x20client\x20ho\
    w\n\x20often\x20a\x20ping\x20request\x20should\x20be\x20issued\x20over\
    \x20the\x20newly\x20created\x20stream.\n\n\x20If\x20this\x20is\x20not\
    \x20set,\x20the\x20client\x20should\x20not\x20issue\x20ping\x20requests.\
    \n\n\x0f\n\x07\x04\x10\x03\x01\x02\0\x06\x12\x04\xd0\x03\x04\x1c\n\x0f\n\
    \x07\x04\x10\x03\x01\x02\0\x01\x12\x04\xd0\x03\x1d*\n\x0f\n\x07\x04\x10\
    \x03\x01\x02\0\x03\x12\x04\xd0\x03-.\n\x0c\n\x04\x04\x10\x02\0\x12\x04\
    \xd3\x03\x02%\n\r\n\x05\x04\x10\x02\0\x06\x12\x04\xd3\x03\x02\x10\n\r\n\
    \x05\x04\x10\x02\0\x01\x12\x04\xd3\x03\x11\x20\n\r\n\x05\x04\x10\x02\0\
    \x03\x12\x04\xd3\x03#$\n\x99\x02\n\x04\x04\x10\x02\x01\x12\x04\xd9\x03\
    \x02)\x1a\x8a\x02\x20A\x20flag\x20set\x20that\x20describes\x20the\x20sta\
    tus\x20of\x20configuration\x20updates\x20based\x20on\x20the\x20provided\
    \n\x20configuration\x20nonces.\n\x200x1:\x20Runtime\x20is\x20up\x20to\
    \x20date\x20and\x20no\x20further\x20update\x20message\x20will\x20be\x20s\
    upplied.\n\x200x2:\x20Configuration\x20is\x20up\x20to\x20date\x20and\x20\
    no\x20further\x20update\x20message\x20will\x20be\x20supplied.\n\n\r\n\
    \x05\x04\x10\x02\x01\x05\x12\x04\xd9\x03\x02\x08\n\r\n\x05\x04\x10\x02\
    \x01\x01\x12\x04\xd9\x03\t$\n\r\n\x05\x04\x10\x02\x01\x03\x12\x04\xd9\
    \x03'(\n\x91\x02\n\x04\x04\x10\x02\x02\x12\x04\xde\x03\x021\x1a\x82\x02\
    \x20Opaque\x20client\x20state\x20that\x20should\x20be\x20echoed\x20back\
    \x20to\x20the\x20server\x20on\x20every\x20future\x20handshake\n\x20reque\
    st.\x20If\x20unset,\x20the\x20client\x20should\x20continue\x20to\x20send\
    \x20any\x20existing\x20opaque\x20state,\x20or\x20none\n\x20if\x20it\x20h\
    as\x20none.\x20Sending\x20an\x20explicit\x20empty\x20value\x20will\x20cl\
    ear\x20any\x20existing\x20state.\n\n\r\n\x05\x04\x10\x02\x02\x04\x12\x04\
    \xde\x03\x02\n\n\r\n\x05\x04\x10\x02\x02\x05\x12\x04\xde\x03\x0b\x10\n\r\
    \n\x05\x04\x10\x02\x02\x01\x12\x04\xde\x03\x11,\n\r\n\x05\x04\x10\x02\
    \x02\x03\x12\x04\xde\x03/0\n}\n\x04\x04\x10\x02\x03\x12\x04\xe2\x03\x026\
    \x1ao\x20If\x20set,\x20the\x20client\x20should\x20update\x20or\x20clear\
    \x20the\x20corresponding\x20state\x20according\x20to\x20the\x20provided\
    \n\x20list\x20of\x20updates.\n\n\r\n\x05\x04\x10\x02\x03\x04\x12\x04\xe2\
    \x03\x02\n\n\r\n\x05\x04\x10\x02\x03\x06\x12\x04\xe2\x03\x0b\x1c\n\r\n\
    \x05\x04\x10\x02\x03\x01\x12\x04\xe2\x03\x1d1\n\r\n\x05\x04\x10\x02\x03\
    \x03\x12\x04\xe2\x0345\n\xa2\x01\n\x04\x04\x10\x02\x04\x12\x04\xe6\x03\
    \x02!\x1a\x93\x01\x20The\x20acknowledgement\x20for\x20the\x20durable\x20\
    stats\x20pipeline\x20analytics\x20report.\x20If\x20absent,\x20the\x20cli\
    ent\n\x20resends\x20the\x20same\x20report\x20ID\x20during\x20its\x20next\
    \x20handshake.\n\n\r\n\x05\x04\x10\x02\x04\x06\x12\x04\xe6\x03\x02\x0e\n\
    \r\n\x05\x04\x10\x02\x04\x01\x12\x04\xe6\x03\x0f\x1c\n\r\n\x05\x04\x10\
    \x02\x04\x03\x12\x04\xe6\x03\x1f\x20\nL\n\x02\x04\x11\x12\x06\xea\x03\0\
    \xed\x03\x01\x1a>\x20A\x20general\x20indication\x20of\x20rate\x20limitin\
    g\x20from\x20server\x20to\x20client.\n\n\x0b\n\x03\x04\x11\x01\x12\x04\
    \xea\x03\x08\x13\nY\n\x04\x04\x11\x02\0\x12\x04\xec\x03\x02+\x1aK\x20Opt\
    ional\x20minimum\x20retry\x20backoff\x20duration\x20that\x20the\x20clien\
    t\x20should\x20adhere\x20to.\n\n\r\n\x05\x04\x11\x02\0\x06\x12\x04\xec\
    \x03\x02\x1a\n\r\n\x05\x04\x11\x02\0\x01\x12\x04\xec\x03\x1b&\n\r\n\x05\
    \x04\x11\x02\0\x03\x12\x04\xec\x03)*\n\xa1\x01\n\x02\x04\x12\x12\x06\xf1\
    \x03\0\x82\x04\x01\x1a\x92\x01\x20A\x20response\x20to\x20an\x20upload\
    \x20request,\x20intended\x20to\x20ack\x20or\x20nack\x20the\x20success\
    \x20of\x20the\n\x20upload.\x20Upon\x20failure,\x20the\x20client\x20might\
    \x20choose\x20to\x20retry\x20this\x20upload.\n\n\x0b\n\x03\x04\x12\x01\
    \x12\x04\xf1\x03\x08\x19\n_\n\x04\x04\x12\x02\0\x12\x04\xf4\x03\x02B\x1a\
    Q\x20The\x20upload\x20UUID\x20provided\x20in\x20the\x20upload\x20request\
    \x20corresponding\x20to\x20this\n\x20response.\n\n\r\n\x05\x04\x12\x02\0\
    \x05\x12\x04\xf4\x03\x02\x08\n\r\n\x05\x04\x12\x02\0\x01\x12\x04\xf4\x03\
    \t\x14\n\r\n\x05\x04\x12\x02\0\x03\x12\x04\xf4\x03\x17\x18\n\r\n\x05\x04\
    \x12\x02\0\x08\x12\x04\xf4\x03\x19A\n\x10\n\x08\x04\x12\x02\0\x08\xaf\
    \x08\x0e\x12\x04\xf4\x03\x1a@\n}\n\x04\x04\x12\x02\x01\x12\x04\xf8\x03\
    \x02\x13\x1ao\x20If\x20set,\x20indicates\x20that\x20the\x20log\x20upload\
    \x20failed.\x20This\x20will\x20be\x20set\x20to\x20a\x20value\n\x20helpfu\
    l\x20for\x20debugging\x20the\x20failure.\n\n\r\n\x05\x04\x12\x02\x01\x05\
    \x12\x04\xf8\x03\x02\x08\n\r\n\x05\x04\x12\x02\x01\x01\x12\x04\xf8\x03\t\
    \x0e\n\r\n\x05\x04\x12\x02\x01\x03\x12\x04\xf8\x03\x11\x12\n\xe7\x01\n\
    \x04\x04\x12\x02\x02\x12\x04\xfd\x03\x02\x1a\x1a\xd8\x01\x20If\x20any\
    \x20logs\x20were\x20dropped\x20due\x20to\x20validation\x20errors,\x20the\
    \x20count\x20will\x20be\x20supplied\x20here.\x20This\x20does\n\x20not\
    \x20count\x20as\x20a\x20total\x20failure\x20and\x20'error'\x20will\x20no\
    t\x20be\x20populated.\x20Debugging\x20information\x20will\x20be\n\x20ava\
    ilable\x20on\x20the\x20server.\n\n\r\n\x05\x04\x12\x02\x02\x05\x12\x04\
    \xfd\x03\x02\x08\n\r\n\x05\x04\x12\x02\x02\x01\x12\x04\xfd\x03\t\x15\n\r\
    \n\x05\x04\x12\x02\x02\x03\x12\x04\xfd\x03\x18\x19\n\x7f\n\x04\x04\x12\
    \x02\x03\x12\x04\x81\x04\x02\x1f\x1aq\x20If\x20set\x20the\x20log\x20uplo\
    ad\x20was\x20blocked\x20due\x20to\x20rate\x20limiting.\x20Further\x20inf\
    ormation\x20is\x20available\x20in\n\x20the\x20`error`\x20field.\n\n\r\n\
    \x05\x04\x12\x02\x03\x06\x12\x04\x81\x04\x02\r\n\r\n\x05\x04\x12\x02\x03\
    \x01\x12\x04\x81\x04\x0e\x1a\n\r\n\x05\x04\x12\x02\x03\x03\x12\x04\x81\
    \x04\x1d\x1e\n\x0c\n\x02\x04\x13\x12\x06\x84\x04\0\xcc\x04\x01\n\x0b\n\
    \x03\x04\x13\x01\x12\x04\x84\x04\x08\x1a\n\x0e\n\x04\x04\x13\x04\0\x12\
    \x06\x85\x04\x02\x91\x04\x03\n\r\n\x05\x04\x13\x04\0\x01\x12\x04\x85\x04\
    \x07\x13\n4\n\x06\x04\x13\x04\0\x02\0\x12\x04\x87\x04\x04\"\x1a$\x20Defa\
    ult\x20value.\x20Should\x20not\x20be\x20used.\n\n\x0f\n\x07\x04\x13\x04\
    \0\x02\0\x01\x12\x04\x87\x04\x04\x1d\n\x0f\n\x07\x04\x13\x04\0\x02\0\x02\
    \x12\x04\x87\x04\x20!\n+\n\x06\x04\x13\x04\0\x02\x01\x12\x04\x8a\x04\x04\
    \x1f\x1a\x1b\x20Periodic\x20upload\x20of\x20stats.\n\n\x0f\n\x07\x04\x13\
    \x04\0\x02\x01\x01\x12\x04\x8a\x04\x04\x1a\n\x0f\n\x07\x04\x13\x04\0\x02\
    \x01\x02\x12\x04\x8a\x04\x1d\x1e\nK\n\x06\x04\x13\x04\0\x02\x02\x12\x04\
    \x8d\x04\x04&\x1a;\x20Upload\x20triggered\x20by\x20a\x20specific\x20even\
    t,\x20e.g.,\x20buffer\x20flush.\n\n\x0f\n\x07\x04\x13\x04\0\x02\x02\x01\
    \x12\x04\x8d\x04\x04!\n\x0f\n\x07\x04\x13\x04\0\x02\x02\x02\x12\x04\x8d\
    \x04$%\nP\n\x06\x04\x13\x04\0\x02\x03\x12\x04\x90\x04\x04\x20\x1a@\x20Up\
    load\x20attached\x20to\x20the\x20initial\x20handshake\x20for\x20a\x20new\
    \x20API\x20stream.\n\n\x0f\n\x07\x04\x13\x04\0\x02\x03\x01\x12\x04\x90\
    \x04\x04\x1b\n\x0f\n\x07\x04\x13\x04\0\x02\x03\x02\x12\x04\x90\x04\x1e\
    \x1f\nf\n\x04\x04\x13\x02\0\x12\x04\x94\x04\x02B\x1aX\x20Upload\x20UUID\
    \x20used\x20to\x20provide\x20idempotence\x20and\x20to\x20correlate\x20a\
    \x20response\x20with\x20this\x20request.\n\n\r\n\x05\x04\x13\x02\0\x05\
    \x12\x04\x94\x04\x02\x08\n\r\n\x05\x04\x13\x02\0\x01\x12\x04\x94\x04\t\
    \x14\n\r\n\x05\x04\x13\x02\0\x03\x12\x04\x94\x04\x17\x18\n\r\n\x05\x04\
    \x13\x02\0\x08\x12\x04\x94\x04\x19A\n\x10\n\x08\x04\x13\x02\0\x08\xaf\
    \x08\x0e\x12\x04\x94\x04\x1a@\n\x0e\n\x04\x04\x13\x03\0\x12\x06\x96\x04\
    \x02\xbf\x04\x03\n\r\n\x05\x04\x13\x03\0\x01\x12\x04\x96\x04\n\x12\n\x10\
    \n\x06\x04\x13\x03\0\x08\0\x12\x06\x97\x04\x04\x9b\x04\x05\n\x0f\n\x07\
    \x04\x13\x03\0\x08\0\x01\x12\x04\x97\x04\n\x17\n\x0f\n\x07\x04\x13\x03\0\
    \x08\0\x02\x12\x04\x98\x04\x06(\n\x11\n\t\x04\x13\x03\0\x08\0\x02\xaf\
    \x08\x12\x04\x98\x04\x06(\n\x0e\n\x06\x04\x13\x03\0\x02\0\x12\x04\x9a\
    \x04\x06\x1e\n\x0f\n\x07\x04\x13\x03\0\x02\0\x06\x12\x04\x9a\x04\x06\x11\
    \n\x0f\n\x07\x04\x13\x03\0\x02\0\x01\x12\x04\x9a\x04\x12\x19\n\x0f\n\x07\
    \x04\x13\x03\0\x02\0\x03\x12\x04\x9a\x04\x1c\x1d\n\x10\n\x06\x04\x13\x03\
    \0\x03\0\x12\x06\x9d\x04\x04\xa5\x04\x05\n\x0f\n\x07\x04\x13\x03\0\x03\0\
    \x01\x12\x04\x9d\x04\x0c\x16\n\xc6\x01\n\x08\x04\x13\x03\0\x03\0\x02\0\
    \x12\x04\xa0\x04\x06_\x1a\xb3\x01\x20The\x20point\x20in\x20time\x20where\
    \x20the\x20first\x20set\x20of\x20stats\x20in\x20this\x20aggregation\x20p\
    eriod\x20was\x20aggregated.\n\x20This\x20allows\x20the\x20server\x20to\
    \x20get\x20some\x20understanding\x20how\x20old\x20the\x20stats\x20being\
    \x20uploaded\x20are.\n\n\x11\n\t\x04\x13\x03\0\x03\0\x02\0\x06\x12\x04\
    \xa0\x04\x06\x1f\n\x11\n\t\x04\x13\x03\0\x03\0\x02\0\x01\x12\x04\xa0\x04\
    \x20,\n\x11\n\t\x04\x13\x03\0\x03\0\x02\0\x03\x12\x04\xa0\x04/0\n\x11\n\
    \t\x04\x13\x03\0\x03\0\x02\0\x08\x12\x04\xa0\x041^\n\x14\n\x0c\x04\x13\
    \x03\0\x03\0\x02\0\x08\xaf\x08\x11\x12\x04\xa0\x042]\n\xc5\x01\n\x08\x04\
    \x13\x03\0\x03\0\x02\x01\x12\x04\xa4\x04\x06/\x1a\xb2\x01\x20When\x20the\
    \x20aggregation\x20was\x20closed.\x20If\x20specified,\x20the\x20server\
    \x20can\x20decide\x20to\x20handle\x20variable\n\x20size\x20aggregation\
    \x20windows\x20by\x20averaging\x20the\x20data\x20over\x20the\x20period\
    \x20or\x20some\x20other\x20heuristic.\n\n\x11\n\t\x04\x13\x03\0\x03\0\
    \x02\x01\x06\x12\x04\xa4\x04\x06\x1f\n\x11\n\t\x04\x13\x03\0\x03\0\x02\
    \x01\x01\x12\x04\xa4\x04\x20*\n\x11\n\t\x04\x13\x03\0\x03\0\x02\x01\x03\
    \x12\x04\xa4\x04-.\n\x81\x01\n\x06\x04\x13\x03\0\x08\x01\x12\x06\xa9\x04\
    \x04\xb0\x04\x05\x1ao\x20To\x20support\x20different\x20kinds\x20of\x20sn\
    apshots,\x20we\x20support\x20providing\x20information\x20about\x20when\
    \x20the\x20data\x20was\n\x20collected.\n\n\x0f\n\x07\x04\x13\x03\0\x08\
    \x01\x01\x12\x04\xa9\x04\n\x15\n\x0f\n\x07\x04\x13\x03\0\x08\x01\x02\x12\
    \x04\xaa\x04\x06(\n\x11\n\t\x04\x13\x03\0\x08\x01\x02\xaf\x08\x12\x04\
    \xaa\x04\x06(\n\xd4\x01\n\x06\x04\x13\x03\0\x02\x01\x12\x04\xaf\x04\x06\
    \x20\x1a\xc3\x01\x20The\x20snapshot\x20data\x20is\x20aggregated\x20over\
    \x20an\x20indefinite\x20period.\x20This\x20supports\x20metrics\x20where\
    \x20we\n\x20care\x20more\x20about\x20the\x20total\x20data\x20(e.g.\x20co\
    unts)\x20than\x20understanding\x20precisely\x20when\x20the\x20data\x20wa\
    s\n\x20recorded.\n\n\x0f\n\x07\x04\x13\x03\0\x02\x01\x06\x12\x04\xaf\x04\
    \x06\x10\n\x0f\n\x07\x04\x13\x03\0\x02\x01\x01\x12\x04\xaf\x04\x11\x1b\n\
    \x0f\n\x07\x04\x13\x03\0\x02\x01\x03\x12\x04\xaf\x04\x1e\x1f\nn\n\x06\
    \x04\x13\x03\0\x02\x02\x12\x04\xb3\x04\x040\x1a^\x20A\x20map\x20of\x20me\
    tric\x20ID\x20to\x20any\x20cardinality\x20overflows\x20that\x20occurred\
    \x20during\x20this\x20snapshot\x20interval.\n\n\x0f\n\x07\x04\x13\x03\0\
    \x02\x02\x06\x12\x04\xb3\x04\x04\x17\n\x0f\n\x07\x04\x13\x03\0\x02\x02\
    \x01\x12\x04\xb3\x04\x18+\n\x0f\n\x07\x04\x13\x03\0\x02\x02\x03\x12\x04\
    \xb3\x04./\nX\n\x06\x04\x13\x03\0\x02\x03\x12\x04\xb6\x04\x04L\x1aH\x20W\
    orkflow\x20ID\x20to\x20debug\x20data\x20that\x20occurred\x20during\x20th\
    is\x20snapshot\x20interval.\n\n\x0f\n\x07\x04\x13\x03\0\x02\x03\x06\x12\
    \x04\xb6\x04\x043\n\x0f\n\x07\x04\x13\x03\0\x02\x03\x01\x12\x04\xb6\x044\
    G\n\x0f\n\x07\x04\x13\x03\0\x02\x03\x03\x12\x04\xb6\x04JK\n\xb0\x01\n\
    \x06\x04\x13\x03\0\x02\x04\x12\x04\xba\x04\x04\x1b\x1a\x9f\x01\x20Number\
    \x20of\x20prior\x20attempts\x20to\x20upload\x20this\x20snapshot.\x20The\
    \x20original\x20upload\x20is\x20zero,\x20which\x20also\n\x20preserves\
    \x20the\x20behavior\x20of\x20clients\x20that\x20do\x20not\x20yet\x20send\
    \x20this\x20field.\n\n\x0f\n\x07\x04\x13\x03\0\x02\x04\x05\x12\x04\xba\
    \x04\x04\n\n\x0f\n\x07\x04\x13\x03\0\x02\x04\x01\x12\x04\xba\x04\x0b\x16\
    \n\x0f\n\x07\x04\x13\x03\0\x02\x04\x03\x12\x04\xba\x04\x19\x1a\n\xab\x01\
    \n\x06\x04\x13\x03\0\x02\x05\x12\x04\xbe\x04\x04%\x1a\x9a\x01\x20Stable\
    \x20monotonic\x20identifier\x20assigned\x20when\x20this\x20source\x20sna\
    pshot\x20is\x20created.\x20Zero\x20indicates\n\x20that\x20the\x20client\
    \x20does\x20not\x20support\x20source\x20sequence\x20identifiers.\n\n\x0f\
    \n\x07\x04\x13\x03\0\x02\x05\x05\x12\x04\xbe\x04\x04\n\n\x0f\n\x07\x04\
    \x13\x03\0\x02\x05\x01\x12\x04\xbe\x04\x0b\x20\n\x0f\n\x07\x04\x13\x03\0\
    \x02\x05\x03\x12\x04\xbe\x04#$\nN\n\x04\x04\x13\x02\x01\x12\x04\xc2\x04\
    \x02N\x1a@\x20A\x20collection\x20of\x20stats\x20snapshots\x20to\x20be\
    \x20recorded\x20by\x20the\x20backend.\n\n\r\n\x05\x04\x13\x02\x01\x04\
    \x12\x04\xc2\x04\x02\n\n\r\n\x05\x04\x13\x02\x01\x06\x12\x04\xc2\x04\x0b\
    \x13\n\r\n\x05\x04\x13\x02\x01\x01\x12\x04\xc2\x04\x14\x1c\n\r\n\x05\x04\
    \x13\x02\x01\x03\x12\x04\xc2\x04\x1f\x20\n\r\n\x05\x04\x13\x02\x01\x08\
    \x12\x04\xc2\x04!M\n\x10\n\x08\x04\x13\x02\x01\x08\xaf\x08\x12\x12\x04\
    \xc2\x04\"L\n\x94\x02\n\x04\x04\x13\x02\x02\x12\x04\xc8\x04\x02(\x1a\x85\
    \x02\x20The\x20point\x20in\x20time\x20when\x20the\x20client\x20initializ\
    ed\x20the\x20process\x20of\x20uploading\x20collected\x20snapshots.\n\x20\
    Used\x20by\x20the\x20server\x20to\x20detect\x20clients\x20with\x20skewed\
    \x20clocks.\n\x20The\x20idea\x20is\x20that\x20upon\x20receiving\x20the\
    \x20stats\x20payload,\x20the\x20server's\x20current\x20time\x20should\
    \x20be\x20close\x20to\x20this\n\x20value.\n\n\r\n\x05\x04\x13\x02\x02\
    \x06\x12\x04\xc8\x04\x02\x1b\n\r\n\x05\x04\x13\x02\x02\x01\x12\x04\xc8\
    \x04\x1c#\n\r\n\x05\x04\x13\x02\x02\x03\x12\x04\xc8\x04&'\n1\n\x04\x04\
    \x13\x02\x03\x12\x04\xcb\x04\x02!\x1a#\x20The\x20reason\x20for\x20this\
    \x20stats\x20upload.\n\n\r\n\x05\x04\x13\x02\x03\x06\x12\x04\xcb\x04\x02\
    \x0e\n\r\n\x05\x04\x13\x02\x03\x01\x12\x04\xcb\x04\x0f\x1c\n\r\n\x05\x04\
    \x13\x02\x03\x03\x12\x04\xcb\x04\x1f\x20\n\x0c\n\x02\x04\x14\x12\x06\xce\
    \x04\0\xd9\x04\x01\n\x0b\n\x03\x04\x14\x01\x12\x04\xce\x04\x08\x1b\n=\n\
    \x04\x04\x14\x02\0\x12\x04\xd0\x04\x02B\x1a/\x20The\x20UUID\x20correspon\
    ding\x20to\x20the\x20upload\x20request.\n\n\r\n\x05\x04\x14\x02\0\x05\
    \x12\x04\xd0\x04\x02\x08\n\r\n\x05\x04\x14\x02\0\x01\x12\x04\xd0\x04\t\
    \x14\n\r\n\x05\x04\x14\x02\0\x03\x12\x04\xd0\x04\x17\x18\n\r\n\x05\x04\
    \x14\x02\0\x08\x12\x04\xd0\x04\x19A\n\x10\n\x08\x04\x14\x02\0\x08\xaf\
    \x08\x0e\x12\x04\xd0\x04\x1a@\nr\n\x04\x04\x14\x02\x01\x12\x04\xd4\x04\
    \x02\x13\x1ad\x20Optional\x20error\x20message\x20which\x20indicates\x20t\
    hat\x20stats\x20upload\x20failed\x20and/or\x20some\x20metrics\x20were\n\
    \x20dropped.\n\n\r\n\x05\x04\x14\x02\x01\x05\x12\x04\xd4\x04\x02\x08\n\r\
    \n\x05\x04\x14\x02\x01\x01\x12\x04\xd4\x04\t\x0e\n\r\n\x05\x04\x14\x02\
    \x01\x03\x12\x04\xd4\x04\x11\x12\n\xb9\x01\n\x04\x04\x14\x02\x02\x12\x04\
    \xd8\x04\x02\x1d\x1a\xaa\x01\x20If\x20any\x20metrics\x20were\x20dropped\
    \x20due\x20to\x20validation\x20errors,\x20the\x20count\x20will\x20be\x20\
    supplied\x20here.\x20Error\n\x20will\x20be\x20populated\x20with\x20debug\
    ging\x20information\x20to\x20help\x20understand\x20the\x20error.\n\n\r\n\
    \x05\x04\x14\x02\x02\x05\x12\x04\xd8\x04\x02\x08\n\r\n\x05\x04\x14\x02\
    \x02\x01\x12\x04\xd8\x04\t\x18\n\r\n\x05\x04\x14\x02\x02\x03\x12\x04\xd8\
    \x04\x1b\x1c\n(\n\x02\x04\x15\x12\x04\xdc\x04\0\x17\x1a\x1c\x20Response\
    \x20to\x20a\x20client\x20ping.\n\n\x0b\n\x03\x04\x15\x01\x12\x04\xdc\x04\
    \x08\x14\n;\n\x02\x04\x16\x12\x06\xdf\x04\0\x8b\x05\x01\x1a-\x20Configur\
    ation\x20update\x20from\x20server\x20to\x20client.\n\n\x0b\n\x03\x04\x16\
    \x01\x12\x04\xdf\x04\x08\x1b\nx\n\x04\x04\x16\x03\0\x12\x06\xe2\x04\x02\
    \xfd\x04\x03\x1ah\x20A\x20complete\x20configuration\x20snapshot.\x20The\
    \x20client\x20should\x20reconfigure\x20to\x20match\x20the\x20supplied\n\
    \x20configuration.\n\n\r\n\x05\x04\x16\x03\0\x01\x12\x04\xe2\x04\n\x19\n\
    d\n\x05\x04\x16\x03\0\n\x12\x04\xe4\x04\x04\x18\x1aU\x20Replaced\x20with\
    \x20`workflow_list`\x20and\x20not\x20available\x20for\x20clients\x20with\
    \x20config_version\x206+.\n\n\x0e\n\x06\x04\x16\x03\0\n\0\x12\x04\xe4\
    \x04\r\x17\n\r\n\x05\x04\x16\x03\0\t\x12\x04\xe5\x04\x04\x0f\n\x0e\n\x06\
    \x04\x16\x03\0\t\0\x12\x04\xe5\x04\r\x0e\n\x0f\n\x07\x04\x16\x03\0\t\0\
    \x01\x12\x04\xe5\x04\r\x0e\n\x0f\n\x07\x04\x16\x03\0\t\0\x02\x12\x04\xe5\
    \x04\r\x0e\n&\n\x06\x04\x16\x03\0\x02\0\x12\x04\xe8\x04\x046\x1a\x16\x20\
    The\x20list\x20of\x20buffers.\n\n\x0f\n\x07\x04\x16\x03\0\x02\0\x06\x12\
    \x04\xe8\x04\x04\x1e\n\x0f\n\x07\x04\x16\x03\0\x02\0\x01\x12\x04\xe8\x04\
    \x1f1\n\x0f\n\x07\x04\x16\x03\0\x02\0\x03\x12\x04\xe8\x0445\n.\n\x06\x04\
    \x16\x03\0\x02\x01\x12\x04\xeb\x04\x04C\x1a\x1e\x20The\x20workflows\x20c\
    onfiguration.\n\n\x0f\n\x07\x04\x16\x03\0\x02\x01\x06\x12\x04\xeb\x04\
    \x04&\n\x0f\n\x07\x04\x16\x03\0\x02\x01\x01\x12\x04\xeb\x04'>\n\x0f\n\
    \x07\x04\x16\x03\0\x02\x01\x03\x12\x04\xeb\x04AB\n5\n\x06\x04\x16\x03\0\
    \x02\x02\x12\x04\xee\x04\x04<\x1a%\x20The\x20list\x20of\x20active\x20bdt\
    ail\x20sessions.\n\n\x0f\n\x07\x04\x16\x03\0\x02\x02\x06\x12\x04\xee\x04\
    \x04\"\n\x0f\n\x07\x04\x16\x03\0\x02\x02\x01\x12\x04\xee\x04#7\n\x0f\n\
    \x07\x04\x16\x03\0\x02\x02\x03\x12\x04\xee\x04:;\n\r\n\x05\x04\x16\x03\0\
    \n\x12\x04\xf0\x04\x04&\n\x0e\n\x06\x04\x16\x03\0\n\x01\x12\x04\xf0\x04\
    \r%\n\r\n\x05\x04\x16\x03\0\t\x12\x04\xf1\x04\x04\x0f\n\x0e\n\x06\x04\
    \x16\x03\0\t\x01\x12\x04\xf1\x04\r\x0e\n\x0f\n\x07\x04\x16\x03\0\t\x01\
    \x01\x12\x04\xf1\x04\r\x0e\n\x0f\n\x07\x04\x16\x03\0\t\x01\x02\x12\x04\
    \xf1\x04\r\x0e\n,\n\x06\x04\x16\x03\0\x02\x03\x12\x04\xf4\x04\x04=\x1a\
    \x1c\x20The\x20filters\x20configuration.\n\n\x0f\n\x07\x04\x16\x03\0\x02\
    \x03\x06\x12\x04\xf4\x04\x04\"\n\x0f\n\x07\x04\x16\x03\0\x02\x03\x01\x12\
    \x04\xf4\x04#8\n\x0f\n\x07\x04\x16\x03\0\x02\x03\x03\x12\x04\xf4\x04;<\n\
    \xd4\x03\n\x06\x04\x16\x03\0\x02\x04\x12\x04\xfc\x04\x04;\x1a\xc3\x03\
    \x20The\x20list\x20of\x20workflows\x20to\x20debug.\x20If\x20the\x20workf\
    low\x20is\x20already\x20deployed,\x20debug\x20data\x20will\x20be\n\x20ge\
    nerated\x20for\x20it\x20alongside\x20the\x20deployed\x20workflow.\x20If\
    \x20the\x20workflow\x20is\x20not\x20deployed,\x20the\n\x20workflow\x20wi\
    ll\x20be\x20executed\x20in\x20debug\x20mode,\x20however\x20actions\x20wi\
    ll\x20*not*\x20be\x20executed\x20(metrics,\n\x20flushes,\x20and\x20so\
    \x20on).\n\x20NOTE:\x20\"already\x20deployed\"\x20implies\x20that\x20the\
    \x20workflow\x20will\x20be\x20found\x20in\x20the\n\x20workflows_configur\
    ation\x20field.\x20The\x20server\x20will\x20not\x20de-dup\x20for\x20simp\
    lification\x20purposes.\n\n\x0f\n\x07\x04\x16\x03\0\x02\x04\x06\x12\x04\
    \xfc\x04\x04&\n\x0f\n\x07\x04\x16\x03\0\x02\x04\x01\x12\x04\xfc\x04'6\n\
    \x0f\n\x07\x04\x16\x03\0\x02\x04\x03\x12\x04\xfc\x049:\n\x8a\x01\n\x04\
    \x04\x16\x02\0\x12\x04\x81\x05\x02\x1b\x1a|\x20A\x20version\x20nonce\x20\
    that\x20can\x20be\x20used\x20for\x20both\x20tracking\x20the\x20last\x20a\
    pplied\x20update\x20as\x20well\x20as\x20for\n\x20responding\x20with\x20a\
    \x20NACK\x20message.\n\n\r\n\x05\x04\x16\x02\0\x05\x12\x04\x81\x05\x02\
    \x08\n\r\n\x05\x04\x16\x02\0\x01\x12\x04\x81\x05\t\x16\n\r\n\x05\x04\x16\
    \x02\0\x03\x12\x04\x81\x05\x19\x1a\n\x0e\n\x04\x04\x16\x08\0\x12\x06\x83\
    \x05\x02\x86\x05\x03\n\r\n\x05\x04\x16\x08\0\x01\x12\x04\x83\x05\x08\x13\
    \nH\n\x04\x04\x16\x02\x01\x12\x04\x85\x05\x04+\x1a:\x20SoTW\x20is\x20the\
    \x20only\x20currently\x20supported\x20configuration\x20type.\n\n\r\n\x05\
    \x04\x16\x02\x01\x06\x12\x04\x85\x05\x04\x13\n\r\n\x05\x04\x16\x02\x01\
    \x01\x12\x04\x85\x05\x14&\n\r\n\x05\x04\x16\x02\x01\x03\x12\x04\x85\x05)\
    *\n}\n\x04\x04\x16\x02\x02\x12\x04\x8a\x05\x026\x1ao\x20If\x20set,\x20th\
    e\x20client\x20should\x20update\x20or\x20clear\x20the\x20corresponding\
    \x20state\x20according\x20to\x20the\x20provided\n\x20list\x20of\x20updat\
    es.\n\n\r\n\x05\x04\x16\x02\x02\x04\x12\x04\x8a\x05\x02\n\n\r\n\x05\x04\
    \x16\x02\x02\x06\x12\x04\x8a\x05\x0b\x1c\n\r\n\x05\x04\x16\x02\x02\x01\
    \x12\x04\x8a\x05\x1d1\n\r\n\x05\x04\x16\x02\x02\x03\x12\x04\x8a\x0545\n5\
    \n\x02\x04\x17\x12\x06\x8e\x05\0\x95\x05\x01\x1a'\x20Runtime\x20update\
    \x20from\x20server\x20to\x20client.\n\n\x0b\n\x03\x04\x17\x01\x12\x04\
    \x8e\x05\x08\x15\n\x8a\x01\n\x04\x04\x17\x02\0\x12\x04\x91\x05\x02\x1b\
    ...
    \x17\x02\0\x05\x12\x04\x91\x05\x02\x08\n\r\n\x05\x04\x17\x02\0\x01\x12\
    \x04\x91\x05\t\x16\n\r\n\x05\x04\x17\x02\0\x03\x12\x04\x91\x05\x19\x1a\n\
    ,\n\x04\x04\x17\x02\x01\x12\x04\x94\x05\x02\x16\x1a\x1e\x20The\x20runtim\
    e\x20instance\x20to\x20use.\n\n\r\n\x05\x04\x17\x02\x01\x06\x12\x04\x94\
    \x05\x02\t\n\r\n\x05\x04\x17\x02\x01\x01\x12\x04\x94\x05\n\x11\n\r\n\x05\
    \x04\x17\x02\x01\x03\x12\x04\x94\x05\x14\x15\n\x8b\x02\n\x02\x04\x18\x12\
    \x06\x9a\x05\0\xa3\x05\x01\x1a\xfc\x01\x20In\x20order\x20to\x20support\
    ...
    \x03\x04\x18\x01\x12\x04\x9a\x05\x08\x15\nA\n\x04\x04\x18\x02\0\x12\x04\
    \x9c\x05\x02\x18\x1a3\x20The\x20status\x20that\x20would\x20have\x20been\
    \x20sent\x20in\x20trailers.\n\n\r\n\x05\x04\x18\x02\0\x05\x12\x04\x9c\
    \x05\x02\x07\n\r\n\x05\x04\x18\x02\0\x01\x12\x04\x9c\x05\x08\x13\n\r\n\
    \x05\x04\x18\x02\0\x03\x12\x04\x9c\x05\x16\x17\nB\n\x04\x04\x18\x02\x01\
    \x12\x04\x9f\x05\x02\x1a\x1a4\x20The\x20message\x20that\x20would\x20have\
    \x20been\x20sent\x20in\x20trailers.\n\n\r\n\x05\x04\x18\x02\x01\x05\x12\
    \x04\x9f\x05\x02\x08\n\r\n\x05\x04\x18\x02\x01\x01\x12\x04\x9f\x05\t\x15\
    \n\r\n\x05\x04\x18\x02\x01\x03\x12\x04\x9f\x05\x18\x19\nH\n\x04\x04\x18\
    \x02\x02\x12\x04\xa2\x05\x02\x1f\x1a:\x20Optional\x20rate\x20limiting\
    \x20that\x20the\x20client\x20should\x20adhere\x20to.\n\n\r\n\x05\x04\x18\
    \x02\x02\x06\x12\x04\xa2\x05\x02\r\n\r\n\x05\x04\x18\x02\x02\x01\x12\x04\
    \xa2\x05\x0e\x1a\n\r\n\x05\x04\x18\x02\x02\x03\x12\x04\xa2\x05\x1d\x1e\n\
    \x86\x02\n\x02\x04\x19\x12\x06\xa8\x05\0\xb0\x05\x01\x1a\xf7\x01\x20Call\
    ...
    ts,\x20etc.).\n\n\x0b\n\x03\x04\x19\x01\x12\x04\xa8\x05\x08\x14\n\x91\
    \x01\n\x04\x04\x19\x02\0\x12\x04\xab\x05\x02%\x1a\x82\x01\x20The\x20list\
    ...
    \x12\x04\xab\x05\x02\n\n\r\n\x05\x04\x19\x02\0\x05\x12\x04\xab\x05\x0b\
    \x11\n\r\n\x05\x04\x19\x02\0\x01\x12\x04\xab\x05\x12\x20\n\r\n\x05\x04\
    \x19\x02\0\x03\x12\x04\xab\x05#$\n\xb4\x01\n\x04\x04\x19\x02\x01\x12\x04\
    \xaf\x05\x02I\x1a\xa5\x01\x20The\x20streaming\x20configuration\x20to\x20\
    ...
    \x01\x06\x12\x04\xaf\x05\x02:\n\r\n\x05\x04\x19\x02\x01\x01\x12\x04\xaf\
    \x05;D\n\r\n\x05\x04\x19\x02\x01\x03\x12\x04\xaf\x05GH\n\xc2\x01\n\x02\
    \x04\x1a\x12\x06\xb4\x05\0\xb8\x05\x01\x1a\xb3\x01\x20Structured\x20data\
    \x20supplied\x20with\x20a\x20terminal\x20device\x20command\x20result.\
    \x20Artifact\x20bytes\x20are\x20uploaded\n\x20separately\x20through\x20`\
    UploadArtifactRequest`\x20and\x20must\x20not\x20be\x20included\x20in\x20\
    this\x20context.\n\n\x0b\n\x03\x04\x1a\x01\x12\x04\xb4\x05\x08\"\n\x9f\
    \x01\n\x04\x04\x1a\x02\0\x12\x04\xb7\x05\x02Q\x1a\x90\x01\x20Command-\
    \x20or\x20transport-supplied\x20fields\x20describing\x20the\x20terminal\
    \x20result.\x20Binary\x20values\x20are\n\x20rejected;\x20artifacts\x20mu\
    st\x20use\x20`UploadArtifactRequest`.\n\n\r\n\x05\x04\x1a\x02\0\x06\x12\
    \x04\xb7\x05\x02\x1e\n\r\n\x05\x04\x1a\x02\0\x01\x12\x04\xb7\x05\x1f%\n\
    \r\n\x05\x04\x1a\x02\0\x03\x12\x04\xb7\x05()\n\r\n\x05\x04\x1a\x02\0\x08\
    \x12\x04\xb7\x05*P\n\x11\n\t\x04\x1a\x02\0\x08\xaf\x08\x13\x02\x12\x04\
    \xb7\x05+O\n8\n\x02\x04\x1b\x12\x06\xbb\x05\0\x88\x06\x01\x1a*\x20Report\
    s\x20an\x20update\x20from\x20a\x20device\x20command.\n\n\x0b\n\x03\x04\
    \x1b\x01\x12\x04\xbb\x05\x08\x1b\n@\n\x04\x04\x1b\x03\0\x12\x06\xbd\x05\
    \x02\xc0\x05\x03\x1a0\x20Confirms\x20that\x20the\x20device\x20accepted\
    \x20the\x20command.\n\n\r\n\x05\x04\x1b\x03\0\x01\x12\x04\xbd\x05\n\x12\
    \n_\n\x06\x04\x1b\x03\0\x02\0\x12\x04\xbf\x05\x04+\x1aO\x20The\x20immuta\
    ble\x20total\x20number\x20of\x20result\x20payload\x20bytes\x20expected\
    \x20from\x20the\x20command.\n\n\x0f\n\x07\x04\x1b\x03\0\x02\0\x04\x12\
    \x04\xbf\x05\x04\x0c\n\x0f\n\x07\x04\x1b\x03\0\x02\0\x05\x12\x04\xbf\x05\
    \r\x13\n\x0f\n\x07\x04\x1b\x03\0\x02\0\x01\x12\x04\xbf\x05\x14&\n\x0f\n\
    \x07\x04\x1b\x03\0\x02\0\x03\x12\x04\xbf\x05)*\nC\n\x04\x04\x1b\x03\x01\
    \x12\x06\xc3\x05\x02\xee\x05\x03\x1a3\x20Confirms\x20that\x20the\x20comm\
    and\x20completed\x20successfully.\n\n\r\n\x05\x04\x1b\x03\x01\x01\x12\
    \x04\xc3\x05\n\x13\n\xcf\x01\n\x06\x04\x1b\x03\x01\x03\0\x12\x06\xc7\x05\
    \x04\xe3\x05\x05\x1a\xbc\x01\x20Declares\x20the\x20complete\x20logical\
    \x20attachment\x20produced\x20by\x20the\x20command.\x20The\x20server\x20\
    verifies\x20this\n\x20declaration\x20against\x20its\x20durable\x20attach\
    ment\x20catalog\x20before\x20reporting\x20the\x20command\x20as\n\x20succ\
    eeded.\n\n\x0f\n\x07\x04\x1b\x03\x01\x03\0\x01\x12\x04\xc7\x05\x0c\x16\n\
    @\n\x08\x04\x1b\x03\x01\x03\0\x03\0\x12\x04\xc9\x05\x06\x15\x1a.\x20The\
    \x20command\x20completed\x20without\x20an\x20attachment.\n\n\x11\n\t\x04\
    \x1b\x03\x01\x03\0\x03\0\x01\x12\x04\xc9\x05\x0e\x12\n_\n\x08\x04\x1b\
    \x03\x01\x03\0\x03\x01\x12\x06\xcc\x05\x06\xcf\x05\x07\x1aK\x20The\x20co\
    mmand\x20produced\x20one\x20artifact\x20uploaded\x20through\x20UploadArt\
    ifactRequest.\n\n\x11\n\t\x04\x1b\x03\x01\x03\0\x03\x01\x01\x12\x04\xcc\
    \x05\x0e\x16\nJ\n\n\x04\x1b\x03\x01\x03\0\x03\x01\x02\0\x12\x04\xce\x05\
    \x08E\x1a6\x20The\x20stable\x20artifact\x20ID\x20from\x20the\x20acknowle\
    dged\x20upload.\n\n\x13\n\x0b\x04\x1b\x03\x01\x03\0\x03\x01\x02\0\x05\
    \x12\x04\xce\x05\x08\x0e\n\x13\n\x0b\x04\x1b\x03\x01\x03\0\x03\x01\x02\0\
    \x01\x12\x04\xce\x05\x0f\x1a\n\x13\n\x0b\x04\x1b\x03\x01\x03\0\x03\x01\
    \x02\0\x03\x12\x04\xce\x05\x1d\x1e\n\x13\n\x0b\x04\x1b\x03\x01\x03\0\x03\
    \x01\x02\0\x08\x12\x04\xce\x05\x1fD\n\x17\n\x0f\x04\x1b\x03\x01\x03\0\
    \x03\x01\x02\0\x08\xaf\x08\x0e\x16\x12\x04\xce\x05\x20C\nY\n\x08\x04\x1b\
    \x03\x01\x03\0\x03\x02\x12\x06\xd2\x05\x06\xd5\x05\x07\x1aE\x20The\x20co\
    mmand\x20produced\x20log\x20batches\x20uploaded\x20through\x20LogUploadR\
    equest.\n\n\x11\n\t\x04\x1b\x03\x01\x03\0\x03\x02\x01\x12\x04\xd2\x05\
    \x0e\x18\ni\n\n\x04\x1b\x03\x01\x03\0\x03\x02\x02\0\x12\x04\xd4\x05\x08&\
    \x1aU\x20The\x20immutable\x20total\x20number\x20of\x20result\x20payload\
    \x20bytes\x20across\x20all\x20acknowledged\x20batches.\n\n\x13\n\x0b\x04\
    \x1b\x03\x01\x03\0\x03\x02\x02\0\x05\x12\x04\xd4\x05\x08\x0e\n\x13\n\x0b\
    \x04\x1b\x03\x01\x03\0\x03\x02\x02\0\x01\x12\x04\xd4\x05\x0f!\n\x13\n\
    \x0b\x04\x1b\x03\x01\x03\0\x03\x02\x02\0\x03\x12\x04\xd4\x05$%\n\x12\n\
    \x08\x04\x1b\x03\x01\x03\0\x08\0\x12\x06\xd7\x05\x06\xe2\x05\x07\n\x11\n\
    \t\x04\x1b\x03\x01\x03\0\x08\0\x01\x12\x04\xd7\x05\x0c\x1b\n\x11\n\t\x04\
    \x1b\x03\x01\x03\0\x08\0\x02\x12\x04\xd8\x05\x08*\n\x13\n\x0b\x04\x1b\
    \x03\x01\x03\0\x08\0\x02\xaf\x08\x12\x04\xd8\x05\x08*\n@\n\x08\x04\x1b\
    \x03\x01\x03\0\x02\0\x12\x04\xdb\x05\x08\x16\x1a.\x20The\x20command\x20c\
    ompleted\x20without\x20an\x20attachment.\n\n\x11\n\t\x04\x1b\x03\x01\x03\
    \0\x02\0\x06\x12\x04\xdb\x05\x08\x0c\n\x11\n\t\x04\x1b\x03\x01\x03\0\x02\
    \0\x01\x12\x04\xdb\x05\r\x11\n\x11\n\t\x04\x1b\x03\x01\x03\0\x02\0\x03\
    \x12\x04\xdb\x05\x14\x15\n<\n\x08\x04\x1b\x03\x01\x03\0\x02\x01\x12\x04\
    \xde\x05\x08\x1e\x1a*\x20The\x20command\x20completed\x20with\x20one\x20a\
    rtifact.\n\n\x11\n\t\x04\x1b\x03\x01\x03\0\x02\x01\x06\x12\x04\xde\x05\
    \x08\x10\n\x11\n\t\x04\x1b\x03\x01\x03\0\x02\x01\x01\x12\x04\xde\x05\x11\
    \x19\n\x11\n\t\x04\x1b\x03\x01\x03\0\x02\x01\x03\x12\x04\xde\x05\x1c\x1d\
    \n\\\n\x08\x04\x1b\x03\x01\x03\0\x02\x02\x12\x04\xe1\x05\x08#\x1aJ\x20Th\
    e\x20command\x20completed\x20with\x20one\x20logical\x20attachment\x20mad\
    e\x20from\x20log\x20batches.\n\n\x11\n\t\x04\x1b\x03\x01\x03\0\x02\x02\
    \x06\x12\x04\xe1\x05\x08\x12\n\x11\n\t\x04\x1b\x03\x01\x03\0\x02\x02\x01\
    \x12\x04\xe1\x05\x13\x1e\n\x11\n\t\x04\x1b\x03\x01\x03\0\x02\x02\x03\x12\
    \x04\xe1\x05!\"\nJ\n\x06\x04\x1b\x03\x01\x02\0\x12\x04\xe6\x05\x04\x1e\
    \x1a:\x20Whether\x20output\x20was\x20limited\x20before\x20the\x20command\
    \x20completed.\n\n\x0f\n\x07\x04\x1b\x03\x01\x02\0\x05\x12\x04\xe6\x05\
    \x04\x08\n\x0f\n\x07\x04\x1b\x03\x01\x02\0\x01\x12\x04\xe6\x05\t\x19\n\
    \x0f\n\x07\x04\x1b\x03\x01\x02\0\x03\x12\x04\xe6\x05\x1c\x1d\nZ\n\x06\
    \x04\x1b\x03\x01\x02\x01\x12\x04\xe9\x05\x04+\x1aJ\x20Optional\x20struct\
    ured\x20context\x20supplied\x20with\x20the\x20successful\x20command\x20r\
    esult.\n\n\x0f\n\x07\x04\x1b\x03\x01\x02\x01\x06\x12\x04\xe9\x05\x04\x1e\
    \n\x0f\n\x07\x04\x1b\x03\x01\x02\x01\x01\x12\x04\xe9\x05\x1f&\n\x0f\n\
    \x07\x04\x1b\x03\x01\x02\x01\x03\x12\x04\xe9\x05)*\n\xb4\x01\n\x06\x04\
    \x1b\x03\x01\x02\x02\x12\x04\xed\x05\x04\x1e\x1a\xa3\x01\x20The\x20attac\
    hment\x20the\x20device\x20completed\x20after\x20uploading.\x20This\x20is\
    \x20optional\x20only\x20for\x20compatibility\n\x20with\x20older\x20clien\
    ts;\x20new\x20command\x20implementations\x20must\x20always\x20set\x20it.\
    \n\n\x0f\n\x07\x04\x1b\x03\x01\x02\x02\x06\x12\x04\xed\x05\x04\x0e\n\x0f\
    \n\x07\x04\x1b\x03\x01\x02\x02\x01\x12\x04\xed\x05\x0f\x19\n\x0f\n\x07\
    \x04\x1b\x03\x01\x02\x02\x03\x12\x04\xed\x05\x1c\x1d\nH\n\x04\x04\x1b\
    \x03\x02\x12\x06\xf1\x05\x02\xf4\x05\x03\x1a8\x20Reports\x20that\x20comm\
    and\x20execution\x20could\x20not\x20be\x20completed.\n\n\r\n\x05\x04\x1b\
    \x03\x02\x01\x12\x04\xf1\x05\n\x10\nV\n\x06\x04\x1b\x03\x02\x02\0\x12\
    \x04\xf3\x05\x04+\x1aF\x20Optional\x20structured\x20context\x20supplied\
    \x20with\x20the\x20failed\x20command\x20result.\n\n\x0f\n\x07\x04\x1b\
    \x03\x02\x02\0\x06\x12\x04\xf3\x05\x04\x1e\n\x0f\n\x07\x04\x1b\x03\x02\
    \x02\0\x01\x12\x04\xf3\x05\x1f&\n\x0f\n\x07\x04\x1b\x03\x02\x02\0\x03\
    \x12\x04\xf3\x05)*\nK\n\x04\x04\x1b\x02\0\x12\x04\xf7\x05\x02>\x1a=\x20T\
    he\x20command\x20ID\x20from\x20the\x20corresponding\x20DeviceCommandRequ\
    est.\n\n\r\n\x05\x04\x1b\x02\0\x05\x12\x04\xf7\x05\x02\x08\n\r\n\x05\x04\
    \x1b\x02\0\x01\x12\x04\xf7\x05\t\x13\n\r\n\x05\x04\x1b\x02\0\x03\x12\x04\
    \xf7\x05\x16\x17\n\r\n\x05\x04\x1b\x02\0\x08\x12\x04\xf7\x05\x18=\n\x11\
    \n\t\x04\x1b\x02\0\x08\xaf\x08\x0e\x16\x12\x04\xf7\x05\x19<\nU\n\x04\x04\
    \x1b\x02\x01\x12\x04\xfa\x05\x02$\x1aG\x20The\x20monotonically\x20increa\
    sing\x20sequence\x20number\x20for\x20this\x20command\x20update.\n\n\r\n\
    \x05\x04\x1b\x02\x01\x05\x12\x04\xfa\x05\x02\x08\n\r\n\x05\x04\x1b\x02\
    \x01\x01\x12\x04\xfa\x05\t\x1f\n\r\n\x05\x04\x1b\x02\x01\x03\x12\x04\xfa\
    \x05\"#\n\x0e\n\x04\x04\x1b\x08\0\x12\x06\xfc\x05\x02\x87\x06\x03\n\r\n\
    \x05\x04\x1b\x08\0\x01\x12\x04\xfc\x05\x08\x13\n\r\n\x05\x04\x1b\x08\0\
    \x02\x12\x04\xfd\x05\x04&\n\x0f\n\x07\x04\x1b\x08\0\x02\xaf\x08\x12\x04\
    \xfd\x05\x04&\n>\n\x04\x04\x1b\x02\x02\x12\x04\x80\x06\x04\x1a\x1a0\x20C\
    onfirms\x20that\x20the\x20device\x20accepted\x20the\x20command.\n\n\r\n\
    \x05\x04\x1b\x02\x02\x06\x12\x04\x80\x06\x04\x0c\n\r\n\x05\x04\x1b\x02\
    \x02\x01\x12\x04\x80\x06\r\x15\n\r\n\x05\x04\x1b\x02\x02\x03\x12\x04\x80\
    \x06\x18\x19\nA\n\x04\x04\x1b\x02\x03\x12\x04\x83\x06\x04\x1c\x1a3\x20Co\
    nfirms\x20that\x20the\x20command\x20completed\x20successfully.\n\n\r\n\
    \x05\x04\x1b\x02\x03\x06\x12\x04\x83\x06\x04\r\n\r\n\x05\x04\x1b\x02\x03\
    \x01\x12\x04\x83\x06\x0e\x17\n\r\n\x05\x04\x1b\x02\x03\x03\x12\x04\x83\
    \x06\x1a\x1b\nF\n\x04\x04\x1b\x02\x04\x12\x04\x86\x06\x04\x16\x1a8\x20Re\
    ports\x20that\x20command\x20execution\x20could\x20not\x20be\x20completed\
    .\n\n\r\n\x05\x04\x1b\x02\x04\x06\x12\x04\x86\x06\x04\n\n\r\n\x05\x04\
    \x1b\x02\x04\x01\x12\x04\x86\x06\x0b\x11\n\r\n\x05\x04\x1b\x02\x04\x03\
    \x12\x04\x86\x06\x14\x15\nH\n\x02\x04\x1c\x12\x06\x8b\x06\0\x94\x06\x01\
    \x1a:\x20Acknowledges\x20that\x20the\x20server\x20persisted\x20a\x20comm\
    and\x20update.\n\n\x0b\n\x03\x04\x1c\x01\x12\x04\x8b\x06\x08\x1e\nK\n\
    \x04\x04\x1c\x02\0\x12\x04\x8d\x06\x02>\x1a=\x20The\x20command\x20ID\x20\
    from\x20the\x20corresponding\x20DeviceCommandRequest.\n\n\r\n\x05\x04\
    \x1c\x02\0\x05\x12\x04\x8d\x06\x02\x08\n\r\n\x05\x04\x1c\x02\0\x01\x12\
    \x04\x8d\x06\t\x13\n\r\n\x05\x04\x1c\x02\0\x03\x12\x04\x8d\x06\x16\x17\n\
    \r\n\x05\x04\x1c\x02\0\x08\x12\x04\x8d\x06\x18=\n\x11\n\t\x04\x1c\x02\0\
    \x08\xaf\x08\x0e\x16\x12\x04\x8d\x06\x19<\nF\n\x04\x04\x1c\x02\x01\x12\
    \x04\x90\x06\x02$\x1a8\x20The\x20command\x20update\x20sequence\x20number\
    \x20that\x20was\x20persisted.\n\n\r\n\x05\x04\x1c\x02\x01\x05\x12\x04\
    \x90\x06\x02\x08\n\r\n\x05\x04\x1c\x02\x01\x01\x12\x04\x90\x06\t\x1f\n\r\
    \n\x05\x04\x1c\x02\x01\x03\x12\x04\x90\x06\"#\nm\n\x04\x04\x1c\x02\x02\
    \x12\x04\x93\x06\x02\x13\x1a_\x20A\x20non-empty\x20error\x20means\x20the\
    ...
    \x93\x06\x02\x08\n\r\n\x05\x04\x1c\x02\x02\x01\x12\x04\x93\x06\t\x0e\n\r\
    \n\x05\x04\x1c\x02\x02\x03\x12\x04\x93\x06\x11\x12\nC\n\x02\x04\x1d\x12\
    \x06\x97\x06\0\x9e\x06\x01\x1a5\x20The\x20response\x20to\x20Sankey\x20di\
    agram\x20path\x20upload\x20request.\n\n\x0b\n\x03\x04\x1d\x01\x12\x04\
    \x97\x06\x08\x20\n=\n\x04\x04\x1d\x02\0\x12\x04\x99\x06\x02B\x1a/\x20The\
    \x20UUID\x20corresponding\x20to\x20the\x20upload\x20request.\n\n\r\n\x05\
    \x04\x1d\x02\0\x05\x12\x04\x99\x06\x02\x08\n\r\n\x05\x04\x1d\x02\0\x01\
    \x12\x04\x99\x06\t\x14\n\r\n\x05\x04\x1d\x02\0\x03\x12\x04\x99\x06\x17\
    \x18\n\r\n\x05\x04\x1d\x02\0\x08\x12\x04\x99\x06\x19A\n\x10\n\x08\x04\
    \x1d\x02\0\x08\xaf\x08\x0e\x12\x04\x99\x06\x1a@\ns\n\x04\x04\x1d\x02\x01\
    \x12\x04\x9d\x06\x02\x13\x1ae\x20Optional\x20error\x20message\x20which\
    \x20indicates\x20that\x20sankey\x20upload\x20failed\x20and/or\x20some\
    \x20metrics\x20were\n\x20dropped.\n\n\r\n\x05\x04\x1d\x02\x01\x05\x12\
    \x04\x9d\x06\x02\x08\n\r\n\x05\x04\x1d\x02\x01\x01\x12\x04\x9d\x06\t\x0e\
    \n\r\n\x05\x04\x1d\x02\x01\x03\x12\x04\x9d\x06\x11\x12\n>\n\x02\x04\x1e\
    \x12\x06\xa1\x06\0\xb2\x06\x01\x1a0\x20The\x20response\x20to\x20Sankey\
    \x20diagram\x20intent\x20request.\n\n\x0b\n\x03\x04\x1e\x01\x12\x04\xa1\
    \x06\x08\x1c\n\x0c\n\x04\x04\x1e\x02\0\x12\x04\xa2\x06\x02B\n\r\n\x05\
    \x04\x1e\x02\0\x05\x12\x04\xa2\x06\x02\x08\n\r\n\x05\x04\x1e\x02\0\x01\
    \x12\x04\xa2\x06\t\x14\n\r\n\x05\x04\x1e\x02\0\x03\x12\x04\xa2\x06\x17\
    \x18\n\r\n\x05\x04\x1e\x02\0\x08\x12\x04\xa2\x06\x19A\n\x10\n\x08\x04\
    \x1e\x02\0\x08\xaf\x08\x0e\x12\x04\xa2\x06\x1a@\n\x0b\n\x03\x04\x1e\t\
    \x12\x04\xa4\x06\x02\r\n\x0c\n\x04\x04\x1e\t\0\x12\x04\xa4\x06\x0b\x0c\n\
    \r\n\x05\x04\x1e\t\0\x01\x12\x04\xa4\x06\x0b\x0c\n\r\n\x05\x04\x1e\t\0\
    \x02\x12\x04\xa4\x06\x0b\x0c\n\x0b\n\x03\x04\x1e\n\x12\x04\xa5\x06\x02\
    \x16\n\x0c\n\x04\x04\x1e\n\0\x12\x04\xa5\x06\x0b\x15\n\x0c\n\x04\x04\x1e\
    \x03\0\x12\x04\xa7\x06\x02\x1e\n\r\n\x05\x04\x1e\x03\0\x01\x12\x04\xa7\
    \x06\n\x1b\n\x0c\n\x04\x04\x1e\x03\x01\x12\x04\xa9\x06\x02\x11\n\r\n\x05\
    \x04\x1e\x03\x01\x01\x12\x04\xa9\x06\n\x0e\n\x0e\n\x04\x04\x1e\x08\0\x12\
    \x06\xab\x06\x02\xb1\x06\x03\n\r\n\x05\x04\x1e\x08\0\x01\x12\x04\xab\x06\
    \x08\x10\nI\n\x04\x04\x1e\x02\x01\x12\x04\xad\x06\x04-\x1a;\x20The\x20ca\
    ndidate\x20sankey\x20path\x20should\x20be\x20uploaded\x20immediately.\n\
    \n\r\n\x05\x04\x1e\x02\x01\x06\x12\x04\xad\x06\x04\x15\n\r\n\x05\x04\x1e\
    \x02\x01\x01\x12\x04\xad\x06\x16(\n\r\n\x05\x04\x1e\x02\x01\x03\x12\x04\
    \xad\x06+,\n<\n\x04\x04\x1e\x02\x02\x12\x04\xb0\x06\x04\x12\x1a.\x20The\
    \x20candidate\x20sankey\x20path\x20should\x20be\x20dropped.\n\n\r\n\x05\
    \x04\x1e\x02\x02\x06\x12\x04\xb0\x06\x04\x08\n\r\n\x05\x04\x1e\x02\x02\
    \x01\x12\x04\xb0\x06\t\r\n\r\n\x05\x04\x1e\x02\x02\x03\x12\x04\xb0\x06\
    \x10\x11\nj\n\x02\x04\x1f\x12\x06\xb5\x06\0\xd9\x06\x01\x1a\\\x20Debug\
    \x20data\x20that\x20is\x20periodically\x20sent\x20when\x20instructed\x20\
    via\x20the\x20DebugControlResponse\x20message.\n\n\x0b\n\x03\x04\x1f\x01\
    \x12\x04\xb5\x06\x08\x18\n\x0e\n\x04\x04\x1f\x03\0\x12\x06\xb6\x06\x02\
    \xc4\x06\x03\n\r\n\x05\x04\x1f\x03\0\x01\x12\x04\xb6\x06\n%\n\x10\n\x06\
    \x04\x1f\x03\0\x08\0\x12\x06\xb7\x06\x04\xbd\x06\x05\n\x0f\n\x07\x04\x1f\
    \x03\0\x08\0\x01\x12\x04\xb7\x06\n\x19\nQ\n\x06\x04\x1f\x03\0\x02\0\x12\
    \x04\xb9\x06\x06\"\x1aA\x20The\x20index\x20of\x20the\x20transition\x20th\
    at\x20was\x20taken\x20to\x20leave\x20this\x20state.\n\n\x0f\n\x07\x04\
    \x1f\x03\0\x02\0\x05\x12\x04\xb9\x06\x06\x0c\n\x0f\n\x07\x04\x1f\x03\0\
    \x02\0\x01\x12\x04\xb9\x06\r\x1d\n\x0f\n\x07\x04\x1f\x03\0\x02\0\x03\x12\
    \x04\xb9\x06\x20!\nC\n\x06\x04\x1f\x03\0\x02\x01\x12\x04\xbc\x06\x06\"\
    \x1a3\x20Whether\x20this\x20transition\x20was\x20a\x20timeout\x20transit\
    ion.\n\n\x0f\n\x07\x04\x1f\x03\0\x02\x01\x05\x12\x04\xbc\x06\x06\n\n\x0f\
    \n\x07\x04\x1f\x03\0\x02\x01\x01\x12\x04\xbc\x06\x0b\x1d\n\x0f\n\x07\x04\
    \x1f\x03\0\x02\x01\x03\x12\x04\xbc\x06\x20!\nY\n\x06\x04\x1f\x03\0\x02\
    \x02\x12\x04\xc0\x06\x04\x20\x1aI\x20The\x20number\x20of\x20times\x20thi\
    s\x20state/transition\x20has\x20been\x20transitioned\x20out\x20of.\n\n\
    \x0f\n\x07\x04\x1f\x03\0\x02\x02\x05\x12\x04\xc0\x06\x04\n\n\x0f\n\x07\
    \x04\x1f\x03\0\x02\x02\x01\x12\x04\xc0\x06\x0b\x1b\n\x0f\n\x07\x04\x1f\
    \x03\0\x02\x02\x03\x12\x04\xc0\x06\x1e\x1f\nN\n\x06\x04\x1f\x03\0\x02\
    \x03\x12\x04\xc3\x06\x047\x1a>\x20The\x20last\x20time\x20this\x20state/t\
    ransition\x20was\x20transitioned\x20out\x20of.\n\n\x0f\n\x07\x04\x1f\x03\
    \0\x02\x03\x06\x12\x04\xc3\x06\x04\x1d\n\x0f\n\x07\x04\x1f\x03\0\x02\x03\
    \x01\x12\x04\xc3\x06\x1e2\n\x0f\n\x07\x04\x1f\x03\0\x02\x03\x03\x12\x04\
    \xc3\x0656\n\x0e\n\x04\x04\x1f\x03\x01\x12\x06\xc6\x06\x02\xc8\x06\x03\n\
    \r\n\x05\x04\x1f\x03\x01\x01\x12\x04\xc6\x06\n\x20\n\x0e\n\x06\x04\x1f\
    \x03\x01\x02\0\x12\x04\xc7\x06\x049\n\x0f\n\x07\x04\x1f\x03\x01\x02\0\
    \x04\x12\x04\xc7\x06\x04\x0c\n\x0f\n\x07\x04\x1f\x03\x01\x02\0\x06\x12\
    \x04\xc7\x06\r(\n\x0f\n\x07\x04\x1f\x03\x01\x02\0\x01\x12\x04\xc7\x06)4\
    \n\x0f\n\x07\x04\x1f\x03\x01\x02\0\x03\x12\x04\xc7\x0678\n\x0e\n\x04\x04\
    \x1f\x03\x02\x12\x06\xca\x06\x02\xd4\x06\x03\n\r\n\x05\x04\x1f\x03\x02\
    \x01\x12\x04\xca\x06\n\x1b\n\x85\x01\n\x06\x04\x1f\x03\x02\x02\0\x12\x04\
    \xcd\x06\x043\x1au\x20The\x20state\x20debug\x20data\x20for\x20each\x20st\
    ...
    \x07\x04\x1f\x03\x02\x02\0\x06\x12\x04\xcd\x06\x04'\n\x0f\n\x07\x04\x1f\
    \x03\x02\x02\0\x01\x12\x04\xcd\x06(.\n\x0f\n\x07\x04\x1f\x03\x02\x02\0\
    \x03\x12\x04\xcd\x0612\n\xa6\x02\n\x06\x04\x1f\x03\x02\x02\x01\x12\x04\
    \xd3\x06\x040\x1a\x95\x02\x20This\x20is\x20incremented\x20every\x20time\
    ...
    \n\x0f\n\x07\x04\x1f\x03\x02\x02\x01\x06\x12\x04\xd3\x06\x04\x1f\n\x0f\n\
    \x07\x04\x1f\x03\x02\x02\x01\x01\x12\x04\xd3\x06\x20+\n\x0f\n\x07\x04\
    \x1f\x03\x02\x02\x01\x03\x12\x04\xd3\x06./\n\x9a\x01\n\x04\x04\x1f\x02\0\
    \x12\x04\xd8\x06\x029\x1a\x8b\x01\x20If\x20instructed\x20to\x20debug\x20\
    ...
    orkflow\x20ID\x20to\x20data.\n\n\r\n\x05\x04\x1f\x02\0\x06\x12\x04\xd8\
    \x06\x02\x20\n\r\n\x05\x04\x1f\x02\0\x01\x12\x04\xd8\x06!4\n\r\n\x05\x04\
    \x1f\x02\0\x03\x12\x04\xd8\x0678\n\n\n\x02\x04\x20\x12\x04\xdb\x06\0\x1e\
    \n\x0b\n\x03\x04\x20\x01\x12\x04\xdb\x06\x08\x1b\nB\n\x02\x04!\x12\x06\
    \xde\x06\0\xf5\x06\x01\x1a4\x20A\x20multiplexed\x20response\x20sent\x20o\
    ver\x20the\x20bitdrift\x20API.\n\n\x0b\n\x03\x04!\x01\x12\x04\xde\x06\
    \x08\x13\n\x0e\n\x04\x04!\x08\0\x12\x06\xdf\x06\x02\xf1\x06\x03\n\r\n\
    \x05\x04!\x08\0\x01\x12\x04\xdf\x06\x08\x15\n\r\n\x05\x04!\x08\0\x02\x12\
    \x04\xe0\x06\x04&\n\x0f\n\x07\x04!\x08\0\x02\xaf\x08\x12\x04\xe0\x06\x04\
    &\n\x0c\n\x04\x04!\x02\0\x12\x04\xe2\x06\x04$\n\r\n\x05\x04!\x02\0\x06\
    \x12\x04\xe2\x06\x04\x15\n\r\n\x05\x04!\x02\0\x01\x12\x04\xe2\x06\x16\
    \x1f\n\r\n\x05\x04!\x02\0\x03\x12\x04\xe2\x06\"#\n\x0c\n\x04\x04!\x02\
    \x01\x12\x04\xe3\x06\x04%\n\r\n\x05\x04!\x02\x01\x06\x12\x04\xe3\x06\x04\
    \x15\n\r\n\x05\x04!\x02\x01\x01\x12\x04\xe3\x06\x16\x20\n\r\n\x05\x04!\
    \x02\x01\x03\x12\x04\xe3\x06#$\n\x0c\n\x04\x04!\x02\x02\x12\x04\xe4\x06\
    \x042\n\r\n\x05\x04!\x02\x02\x06\x12\x04\xe4\x06\x04\x1b\n\r\n\x05\x04!\
    \x02\x02\x01\x12\x04\xe4\x06\x1c-\n\r\n\x05\x04!\x02\x02\x03\x12\x04\xe4\
    \x0601\n\x0c\n\x04\x04!\x02\x03\x12\x04\xe5\x06\x04)\n\r\n\x05\x04!\x02\
    \x03\x06\x12\x04\xe5\x06\x04\x17\n\r\n\x05\x04!\x02\x03\x01\x12\x04\xe5\
    \x06\x18$\n\r\n\x05\x04!\x02\x03\x03\x12\x04\xe5\x06'(\n\x0c\n\x04\x04!\
    \x02\x04\x12\x04\xe6\x06\x04\x1a\n\r\n\x05\x04!\x02\x04\x06\x12\x04\xe6\
    \x06\x04\x10\n\r\n\x05\x04!\x02\x04\x01\x12\x04\xe6\x06\x11\x15\n\r\n\
    \x05\x04!\x02\x04\x03\x12\x04\xe6\x06\x18\x19\n\x0c\n\x04\x04!\x02\x05\
    \x12\x04\xe7\x06\x041\n\r\n\x05\x04!\x02\x05\x06\x12\x04\xe7\x06\x04\x17\
    \n\r\n\x05\x04!\x02\x05\x01\x12\x04\xe7\x06\x18,\n\r\n\x05\x04!\x02\x05\
    \x03\x12\x04\xe7\x06/0\n\x0c\n\x04\x04!\x02\x06\x12\x04\xe8\x06\x04%\n\r\
    \n\x05\x04!\x02\x06\x06\x12\x04\xe8\x06\x04\x11\n\r\n\x05\x04!\x02\x06\
    \x01\x12\x04\xe8\x06\x12\x20\n\r\n\x05\x04!\x02\x06\x03\x12\x04\xe8\x06#\
    $\n\x0c\n\x04\x04!\x02\x07\x12\x04\xe9\x06\x04%\n\r\n\x05\x04!\x02\x07\
    \x06\x12\x04\xe9\x06\x04\x11\n\r\n\x05\x04!\x02\x07\x01\x12\x04\xe9\x06\
    \x12\x20\n\r\n\x05\x04!\x02\x07\x03\x12\x04\xe9\x06#$\n\x0c\n\x04\x04!\
    \x02\x08\x12\x04\xea\x06\x04#\n\r\n\x05\x04!\x02\x08\x06\x12\x04\xea\x06\
    \x04\x10\n\r\n\x05\x04!\x02\x08\x01\x12\x04\xea\x06\x11\x1e\n\r\n\x05\
    \x04!\x02\x08\x03\x12\x04\xea\x06!\"\n\x0c\n\x04\x04!\x02\t\x12\x04\xeb\
    \x06\x048\n\r\n\x05\x04!\x02\t\x06\x12\x04\xeb\x06\x04\x1c\n\r\n\x05\x04\
    !\x02\t\x01\x12\x04\xeb\x06\x1d2\n\r\n\x05\x04!\x02\t\x03\x12\x04\xeb\
    \x0657\n\x0c\n\x04\x04!\x02\n\x12\x04\xec\x06\x045\n\r\n\x05\x04!\x02\n\
    \x06\x12\x04\xec\x06\x04\x18\n\r\n\x05\x04!\x02\n\x01\x12\x04\xec\x06\
    \x19/\n\r\n\x05\x04!\x02\n\x03\x12\x04\xec\x0624\n\x0c\n\x04\x04!\x02\
    \x0b\x12\x04\xed\x06\x040\n\r\n\x05\x04!\x02\x0b\x06\x12\x04\xed\x06\x04\
    \x1a\n\r\n\x05\x04!\x02\x0b\x01\x12\x04\xed\x06\x1b*\n\r\n\x05\x04!\x02\
    \x0b\x03\x12\x04\xed\x06-/\n\x0c\n\x04\x04!\x02\x0c\x12\x04\xee\x06\x046\
    \n\r\n\x05\x04!\x02\x0c\x06\x12\x04\xee\x06\x04\x20\n\r\n\x05\x04!\x02\
    \x0c\x01\x12\x04\xee\x06!0\n\r\n\x05\x04!\x02\x0c\x03\x12\x04\xee\x0635\
    \n\x0c\n\x04\x04!\x02\r\x12\x04\xef\x06\x04*\n\r\n\x05\x04!\x02\r\x06\
    \x12\x04\xef\x06\x04\x17\n\r\n\x05\x04!\x02\r\x01\x12\x04\xef\x06\x18$\n\
    \r\n\x05\x04!\x02\r\x03\x12\x04\xef\x06')\n\x0c\n\x04\x04!\x02\x0e\x12\
    \x04\xf0\x06\x04:\n\r\n\x05\x04!\x02\x0e\x06\x12\x04\xf0\x06\x04\x1a\n\r\
    \n\x05\x04!\x02\x0e\x01\x12\x04\xf0\x06\x1b4\n\r\n\x05\x04!\x02\x0e\x03\
    \x12\x04\xf0\x0679\n\x0b\n\x03\x04!\t\x12\x04\xf3\x06\x02\x0e\n\x0c\n\
    \x04\x04!\t\0\x12\x04\xf3\x06\x0b\r\n\r\n\x05\x04!\t\0\x01\x12\x04\xf3\
    \x06\x0b\r\n\r\n\x05\x04!\t\0\x02\x12\x04\xf3\x06\x0b\r\n\x0b\n\x03\x04!\
    \t\x12\x04\xf4\x06\x02\x0e\n\x0c\n\x04\x04!\t\x01\x12\x04\xf4\x06\x0b\r\
    \n\r\n\x05\x04!\t\x01\x01\x12\x04\xf4\x06\x0b\r\n\r\n\x05\x04!\t\x01\x02\
    \x12\x04\xf4\x06\x0b\r\n\x0c\n\x02\x06\0\x12\x06\xf7\x06\0\xf9\x06\x01\n\
    \x0b\n\x03\x06\0\x01\x12\x04\xf7\x06\x08\x12\n\x0c\n\x04\x06\0\x02\0\x12\
    \x04\xf8\x06\x02:\n\r\n\x05\x06\0\x02\0\x01\x12\x04\xf8\x06\x06\t\n\r\n\
    \x05\x06\0\x02\0\x05\x12\x04\xf8\x06\n\x10\n\r\n\x05\x06\0\x02\0\x02\x12\
    \x04\xf8\x06\x11\x1b\n\r\n\x05\x06\0\x02\0\x06\x12\x04\xf8\x06&,\n\r\n\
    \x05\x06\0\x02\0\x03\x12\x04\xf8\x06-8b\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::state_payload::file_descriptor().clone());
            ...
            messages.push(client_state_update::ClearClientState::generated_message_descriptor_data());
            messages.push(client_state_update::SetClientState::generated_message_descriptor_data());
            ...
            messages.push(handshake_request::Analytics::generated_message_descriptor_data());
            messages.push(handshake_request::analytics::StatsPipelineAnalyticsReport::generated_message_descriptor_data());
            ...
            messages.push(handshake_response::AnalyticsAck::generated_message_descriptor_data());
            ...
            enums.push(ArtifactPayloadEncoding::generated_enum_descriptor_data());
