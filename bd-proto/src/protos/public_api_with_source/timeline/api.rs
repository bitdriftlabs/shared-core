...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    .timeline.v1.SessionAdvancedSearchResponseJ\x9f\x0e\n\x06\x12\x04\x06\04\
    ...
    \x12\x03\x0e\07\nu\n\x02\x06\0\x12\x04\x11\04\x01\x1ai\x20Provides\x20ac\
    cess\x20to\x20session\x20timeline\x20data,\x20including\x20logs,\x20meta\
    data,\x20feature\x20flags,\x20and\x20hydration\x20state.\n\n\n\n\x03\x06\
    \0\x01\x12\x03\x11\x08\x17\n\x7f\n\x04\x06\0\x02\0\x12\x04\x15\x02\x93\
    \x01\x1aq\x20Retrieves\x20the\x20logs\x20for\x20a\x20session.\n\n\x20Ret\
    urns\x20the\x20gRPC\x20NOT_FOUND\x20status\x20if\x20the\x20session\x20ha\
    s\x20not\x20been\x20hydrated\x20yet.\n\n\x0c\n\x05\x06\0\x02\0\x01\x12\
    \x03\x15\x06\x14\n\x0c\n\x05\x06\0\x02\0\x02\x12\x03\x15\x15M\n\r\n\x05\
    \x06\0\x02\0\x03\x12\x04\x15X\x91\x01\n\x8f\x01\n\x04\x06\0\x02\x01\x12\
    \x04\x1a\x02\x93\x01\x1a\x80\x01\x20Retrieves\x20metadata\x20and\x20attr\
    ibutes\x20for\x20a\x20session.\n\n\x20Returns\x20the\x20gRPC\x20NOT_FOUN\
    D\x20status\x20if\x20the\x20session\x20has\x20not\x20been\x20hydrated\
    \x20yet.\n\n\x0c\n\x05\x06\0\x02\x01\x01\x12\x03\x1a\x06\x14\n\x0c\n\x05\
    \x06\0\x02\x01\x02\x12\x03\x1a\x15M\n\r\n\x05\x06\0\x02\x01\x03\x12\x04\
    \x1aX\x91\x01\n\xa9\x01\n\x04\x06\0\x02\x02\x12\x04\x20\x02\x93\x01\x1a\
    \x9a\x01\x20Triggers\x20hydration\x20of\x20a\x20session.\n\n\x20Hydratio\
    n\x20prepares\x20session\x20data\x20for\x20querying.\x20Can\x20also\x20b\
    e\x20used\x20to\x20force\n\x20re-hydration\x20of\x20an\x20already\x20hyd\
    rated\x20session.\n\n\x0c\n\x05\x06\0\x02\x02\x01\x12\x03\x20\x06\x14\n\
    \x0c\n\x05\x06\0\x02\x02\x02\x12\x03\x20\x15M\n\r\n\x05\x06\0\x02\x02\
    \x03\x12\x04\x20X\x91\x01\n\x9b\x01\n\x04\x06\0\x02\x03\x12\x04&\x02\x9f\
    \x01\x1a\x8c\x01\x20Retrieves\x20the\x20hydration\x20status\x20of\x20a\
    \x20session.\n\n\x20Returns\x20the\x20gRPC\x20NOT_FOUND\x20status\x20if\
    \x20hydration\x20has\x20not\x20been\x20triggered\x20for\x20the\n\x20sess\
    ion\x20yet.\n\n\x0c\n\x05\x06\0\x02\x03\x01\x12\x03&\x06\x18\n\x0c\n\x05\
    \x06\0\x02\x03\x02\x12\x03&\x19U\n\r\n\x05\x06\0\x02\x03\x03\x12\x04&`\
    \x9d\x01\n\x9b\x01\n\x04\x06\0\x02\x04\x12\x04+\x02\x96\x01\x1a\x8c\x01\
    \x20Searches\x20spans\x20within\x20a\x20session.\n\n\x20Supports\x20filt\
    ering\x20by\x20span\x20name\x20or\x20span\x20ID\x20and\x20can\x20limit\
    \x20returned\x20child\x20depth\x20and\x20top-level\x20pagination.\n\n\
    \x0c\n\x05\x06\0\x02\x04\x01\x12\x03+\x06\x11\n\x0c\n\x05\x06\0\x02\x04\
    \x02\x12\x03+\x12M\n\r\n\x05\x06\0\x02\x04\x03\x12\x04+X\x94\x01\n\x98\
    \x02\n\x04\x06\0\x02\x05\x12\x043\x02\xa8\x01\x1a\x89\x02\x20Performs\
    \x20an\x20advanced\x20search\x20across\x20logs\x20in\x20a\x20session.\n\
    \n\x20Supports\x20filtering\x20by\x20field\x20values,\x20log\x20types,\
    \x20log\x20levels,\x20and\x20full-text\n\x20content\x20using\x20a\x20fle\
    xible\x20query\x20model\x20with\x20AND/OR\x20logic.\n\n\x20Returns\x20th\
    e\x20gRPC\x20NOT_FOUND\x20status\x20if\x20the\x20session\x20has\x20not\
    \x20been\x20hydrated\x20yet.\n\n\x0c\n\x05\x06\0\x02\x05\x01\x12\x033\
    \x06\x1b\n\x0c\n\x05\x06\0\x02\x05\x02\x12\x033\x1c[\n\r\n\x05\x06\0\x02\
    \x05\x03\x12\x043f\xa6\x01b\x06proto3\
";
