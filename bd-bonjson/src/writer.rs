...
impl<W: std::io::Write + Send + Sync> Writer<W> {
  ...
  pub fn write_null(&mut self) -> Result<usize> {
    ...
    let size = serialize_primitives::serialize_null_slice(&mut buffer[..])?;
  ...
  pub fn write_boolean(&mut self, v: bool) -> Result<usize> {
    let mut buffer: [u8; 1] = [0; 1];
    let size = serialize_primitives::serialize_boolean_slice(&mut buffer[..], v)?;
    self.write_bytes(&buffer[.. size])
  }
  ...
  pub fn write_signed(&mut self, v: i64) -> Result<usize> {
    ...
    let size = serialize_primitives::serialize_i64_slice(&mut buffer[..], v)?;
    self.write_bytes(&buffer[.. size])
  }
  ...
  pub fn write_unsigned(&mut self, v: u64) -> Result<usize> {
    let mut buffer: [u8; 16] = [0; 16];
    let size = serialize_primitives::serialize_u64_slice(&mut buffer[..], v)?;
    self.write_bytes(&buffer[.. size])
  }
  ...
  pub fn write_float(&mut self, v: f64) -> Result<usize> {
    let mut buffer: [u8; 16] = [0; 16];
    let size = serialize_primitives::serialize_f64_slice(&mut buffer[..], v)?;
    self.write_bytes(&buffer[.. size])
  }
  ...
  pub fn write_f32(&mut self, v: f32) -> Result<usize> {
    let mut buffer: [u8; 16] = [0; 16];
    let size = serialize_primitives::serialize_f32_slice(&mut buffer[..], v)?;
    self.write_bytes(&buffer[.. size])
  }
  ...
  pub fn write_str(&mut self, v: &str) -> Result<usize> {
    let mut buffer: [u8; 16] = [0; 16];
    let header_size = serialize_primitives::serialize_string_header_slice(&mut buffer[..], v)?;
  ...
  pub fn write_array_begin(&mut self) -> Result<usize> {
    let mut buffer: [u8; 1] = [0; 1];
    let size = serialize_primitives::serialize_array_begin_slice(&mut buffer[..])?;
    self.write_bytes(&buffer[.. size])
  }
  ...
  pub fn write_map_begin(&mut self) -> Result<usize> {
    let mut buffer: [u8; 1] = [0; 1];
    let size = serialize_primitives::serialize_map_begin_slice(&mut buffer[..])?;
    self.write_bytes(&buffer[.. size])
  }
  ...
  pub fn write_container_end(&mut self) -> Result<usize> {
    let mut buffer: [u8; 1] = [0; 1];
    let size = serialize_primitives::serialize_container_end_slice(&mut buffer[..])?;
    self.write_bytes(&buffer[.. size])
  }
}
